...
<div class="body">
    ...
    <?php if($letter->use_default_content ?? true): ?>
        ...
        duties as <b><?php echo e($employee->designation); ?></b> at <b><?php echo e($company_name); ?></b>. 
...
<div class="signature">
    ...
    <div class="name"><?php echo e($signatory_name ?? 'HR Manager'); ?></div>
    <div class="company"><?php echo e($company_name); ?></div>
</div><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/hr/employees/letters/templates/impartiality.blade.php ENDPATH**/ ?>