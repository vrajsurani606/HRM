...
<body>
            ...
            <table style="width: 100%;">
                <tr>
                    <td>
                        ...
                        <div style="font-size: 17px; margin-left: 0; margin-bottom: 28px; color: #4a5568; line-height: 1.6;">We develop <?php echo e($quotation->quotation_title ?? 'Software'); ?> so you don't have to</div>
    ...
    <div class="page" style="position: relative;">
        ...
        <div style="position: relative;">
            <tr>
                <td>                        
                    <div style="font-size: 26px; font-weight: 700; margin-bottom: 16px; color: #1a1a1a; letter-spacing: -0.01em;">We develop <?php echo e($quotation->quotation_title ?? 'Software'); ?> so you don't have to</div>
                    <div style="margin-bottom: 24px;"></div>
                    <div style="font-size: 17px; line-height: 1.8; margin-bottom: 24px; text-align: justify; color: #2d3748;">We are living in the age of connectivity, and that means more things than ever before are right at your fingertips — literally. With one press of the button, one swipe left or right, you can open up new worlds in seconds. We're talking about <?php echo e($quotation->quotation_title ?? 'Software'); ?>.</div>
                    <div style="font-size: 17px; line-height: 1.8; margin-bottom: 24px; text-align: justify; color: #2d3748;">But at <?php echo e($quotation->own_company_name ?? 'Enlargesoft'); ?>, we don't just talk about <?php echo e($quotation->quotation_title ?? 'Software'); ?>; we live and breathe <?php echo e($quotation->quotation_title ?? 'Software'); ?>. We have assembled a team of the best and brightest minds in <?php echo e($quotation->quotation_title ?? 'Software'); ?> development, marketing, and leadership, giving our clients access to the most cutting-edge technology. You can rest assured you're in good hands, as we have years of experience in <?php echo e($quotation->quotation_title ?? 'Software'); ?> development.</div>
                    <div style="font-size: 17px; line-height: 1.8; margin-bottom: 24px; text-align: justify; color: #2d3748;">Our goal is to create something you're proud of and that helps your business. <?php echo e($quotation->quotation_title ?? 'Software'); ?> can be transcendent, and they can also be colossal failures. That's why <?php echo e($quotation->own_company_name ?? 'Enlargesoft'); ?> has developed a comprehensive approach to <?php echo e($quotation->quotation_title ?? 'Software'); ?> development that takes the guessing out of the game. We're ecstatic that you're considering doing business with us, so let's get started.</div>
                    ...
                    <div style="font-size: 17px; line-height: 1.8; margin-bottom: 24px; text-align: justify; color: #2d3748;"><?php echo e($quotation->quotation_title ?? 'Software'); ?> development is serious business. It takes time and patience to create something that works for you and is free of bugs and other issues. Updates are required, but it's important to start with a sound foundation. At <?php echo e($quotation->own_company_name ?? 'Enlargesoft'); ?>, we believe in a thorough approach that provides our clients with as much engagement as they request. While our entire team will be developing your <?php echo e($quotation->quotation_title ?? 'Software'); ?>, we will assign a project lead who will be your main point of contact.</div>
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <div style="font-size: 17px; line-height: 1.8; margin-bottom: 32px; text-align: justify; color: #2d3748;">
                            We will gather information about your company and how it works. We will figure out who your customers are and how we can attract more through your new <?php echo e($quotation->quotation_title ?? 'Software'); ?>. Audience engagement, research, and branding are key in <?php echo e($quotation->quotation_title ?? 'Software'); ?> development, and we will conduct focus groups to find out why people choose <strong style="font-weight: 600; color: #1a1a1a;"><?php echo e($quotation->company_name); ?></strong>.
                        </div>
                        ...
                        <div style="font-size: 17px; line-height: 1.8; margin-bottom: 24px; text-align: justify; color: #2d3748;">
                            Like a <?php echo e($quotation->quotation_title ?? 'Software'); ?>, <?php echo e($quotation->quotation_title ?? 'Software'); ?> needs a sitemap and wireframes. Think of this as the structural integrity of a skyscraper. Will have an important role in the design process, as it's important that you are getting what you want. Plus, it's better workable issues in this stage than later down the road. Here are some highlights of this process:
                        </div>
                        ...
                        <div style="font-size: 17px; line-height: 1.8; margin-bottom: 24px; text-align: justify; color: #2d3748;">
                            We're almost there. Your new <?php echo e($quotation->quotation_title ?? 'Software'); ?> is built and ready to launch. But before that happens, <?php echo e($quotation->own_company_name ?? 'CHITRI ENLARGE SOFT IT HUB PVT LTD (CEIHPL)'); ?> and <?php echo e($quotation->company_name); ?> need to collaborate on a marketing strategy. After all, just because you invested all this time and money into your <?php echo e($quotation->quotation_title ?? 'Software'); ?>, it doesn't mean anyone will know it exists unless we tell them.
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table style="width: 100%; height: 100%;">
                ...
                <td style="vertical-align: top;">                                        
                    <table class="inner-table" cellspacing="0" style="width:100%; border-collapse:separate; margin:20px 0; border-radius:8px; overflow:hidden;">                                                
                        <tr>                                                        
                            <td colspan="4" style="font-size:17px; color:#2d3748; line-height:1.8; background:#fff; border-radius:8px 8px 0 0; text-align: justify;"><?php echo e($quotation->own_company_name ?? 'Enlargesoft'); ?> estimates that it will take <?php echo e($quotation->completion_time ?? '90 Days'); ?> to complete your new <?php echo e($quotation->quotation_title ?? 'Software'); ?>. Upon signing this agreement, we can begin immediately. Here's what to expect:</td>                                                                            
                        </tr>                                                
                        <tr>
                            <td colspan="4" style="height:32px;"></td>
                        </tr>                                                
                        <tr>                                                        
                            <td colspan="4" style="background:#3B86B3 !important; color:#ffffff !important; text-align:center; font-size:18px; font-weight:700; padding:16px; border-radius:8px 8px 0 0; letter-spacing:0.01em; -webkit-print-color-adjust:exact !important; print-color-adjust:exact !important;">Timeline for <?php echo e($quotation->quotation_title ?? 'Software'); ?> Development</td>                                                    
                        </tr>                                                
                        <tr>                                                        
                        ...
                        <tr>                                                        
                            <td colspan="2" style="padding:14px 16px; border:1px solid #e2e8f0; border-radius:0 0 0 8px; font-weight:600; font-size:15px; color:#2d3748;">Development For <?php echo e($quotation->quotation_title ?? 'Software'); ?></td>                                                        
                    ...
                    <table class="inner-table" cellspacing="0">                                                
                        ...
                        <tr>                                                        
                            <td colspan="4" style="font-size:17px; color:#2d3748; line-height:1.8; text-align:justify;">We want to receive the utmost value from your investment in new <?php echo e($quotation->quotation_title ?? 'Software'); ?>. This budget breakdown is based on the project outline described above. Please contact your project lead with any issues or questions before signing.</td>                                                    
                        </tr>                                                
                        <tr>
                            <td colspan="4" style="height:32px;"></td>
                        </tr>                                                
