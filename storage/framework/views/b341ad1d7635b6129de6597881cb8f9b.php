<?php $__env->startSection('page_title', 'Create New Letter - ' . $employee->name); ?>
...
<div class="hrp-card">
    <div class="Rectangle-30 hrp-compact">
        <form method="POST" action="<?php echo e(isset($letter) ? route('employees.letters.update', ['employee'=>$employee, 'letter'=>$letter]) : route('employees.letters.store', $employee)); ?>" enctype="multipart/form-data" class="hrp-form grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3" id="letterForm">
            <?php echo csrf_field(); ?>
            <?php if(isset($letter)): ?>
            ...
            <div>
                ...
                <input type="text" class="hrp-input Rectangle-29" value="<?php echo e($employee->name); ?>" readonly>
            </div>
            
            <div>
                <label class="hrp-label">Employee ID:</label>
                <input type="text" class="hrp-input Rectangle-29" value="<?php echo e($employee->code); ?>" readonly>
            </div>
            
            <div>
                <label class="hrp-label">Reference Number: <span class="text-red-500">*</span></label>
                <div class="flex">
                    <input type="text" name="reference_number" id="reference_number" value="<?php echo e(old('reference_number', $referenceNumber)); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select name="type" id="type" class="hrp-input Rectangle-29" required>
                    ...
                    <option value="offer" <?php echo e($t == 'offer' ? 'selected' : ''); ?>>Offer Letter</option>
                    <option value="joining" <?php echo e($t == 'joining' ? 'selected' : ''); ?>>Joining Letter</option>
                    <option value="confidentiality" <?php echo e($t == 'confidentiality' ? 'selected' : ''); ?>>Confidentiality Letter</option>
                    <option value="impartiality" <?php echo e($t == 'impartiality' ? 'selected' : ''); ?>>Impartiality Letter</option>
                    <option value="experience" <?php echo e($t == 'experience' ? 'selected' : ''); ?>>Experience Letter</option>
                    <option value="agreement" <?php echo e($t == 'agreement' ? 'selected' : ''); ?>>Agreement Letter</option>
                    <option value="warning" <?php echo e($t == 'warning' ? 'selected' : ''); ?>>Warning Letter</option>
                    <option value="termination" <?php echo e($t == 'termination' ? 'selected' : ''); ?>>Termination Letter</option>
                    <option value="increment" <?php echo e($t == 'increment' ? 'selected' : ''); ?>>Increment Letter</option>
                    <option value="internship_offer" <?php echo e($t == 'internship_offer' ? 'selected' : ''); ?>>Internship Offer Letter</option>
                    <option value="internship_letter" <?php echo e($t == 'internship_letter' ? 'selected' : ''); ?>>Internship Letter</option>
                    <option value="other" <?php echo e($t == 'other' ? 'selected' : ''); ?>>Other</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="title" id="title" class="hrp-input Rectangle-29" 
                       placeholder="Enter letter title" value="<?php echo e(old('title', isset($letter)?$letter->title:'')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="issue_date" id="issue_date" class="hrp-input Rectangle-29 date-picker" 
                       placeholder="dd/mm/yyyy" value="<?php echo e(old('issue_date', isset($letter) ? optional($letter->issue_date)->format('d/m/Y') : now()->format('d/m/Y'))); ?>" required autocomplete="off">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="start_date" id="start_date" class="hrp-input Rectangle-29 date-picker" 
                               placeholder="dd/mm/yyyy" value="<?php echo e(old('start_date', isset($letter)?optional($letter->start_date)->format('d/m/Y'):optional($employee->joining_date)->format('d/m/Y'))); ?>" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="end_date" id="end_date" class="hrp-input Rectangle-29 date-picker" 
                               placeholder="dd/mm/yyyy" value="<?php echo e(old('end_date', isset($letter)?optional($letter->end_date)->format('d/m/Y'):now()->format('d/m/Y'))); ?>" autocomplete="off">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="end_date" id="termination_date" class="hrp-input Rectangle-29 date-picker" 
                               placeholder="dd/mm/yyyy" value="<?php echo e(old('end_date', isset($letter)?optional($letter->end_date)->format('d/m/Y'):null)); ?>" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="notes" id="termination_notes" class="hrp-input Rectangle-29" 
                               placeholder="Additional notes" value="<?php echo e(old('notes')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea data-field="content" id="termination_reason" class="form-control summernote-notes w-full" 
                             placeholder="Enter detailed reason for termination (e.g., consistently low performance despite prior discussions and performance improvement plans)" style="min-height: 200px;"><?php echo e(old('content', isset($letter) && $letter->type == 'termination' ? $letter->content : '')); ?></textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="monthly_salary" id="current_salary" class="hrp-input Rectangle-29" 
                               placeholder="Current monthly salary" value="<?php echo e(old('monthly_salary', isset($letter)?$letter->monthly_salary:'')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="increment_amount" id="new_salary" class="hrp-input Rectangle-29" 
                               placeholder="New monthly salary" value="<?php echo e(old('increment_amount', isset($letter)?$letter->increment_amount:'')); ?>">
                        <?php $__errorArgs = ['increment_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="increment_effective_date" id="increment_effective_date" class="hrp-input Rectangle-29 date-picker" 
                               placeholder="dd/mm/yyyy" value="<?php echo e(old('increment_effective_date', isset($letter)?optional($letter->increment_effective_date)->format('d/m/Y'):null)); ?>" autocomplete="off">
                        <?php $__errorArgs = ['increment_effective_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="internship_position" id="internship_position" class="hrp-input Rectangle-29" 
                               placeholder="e.g., Full Stack Developer" value="<?php echo e(old('internship_position', isset($letter)?$letter->internship_position:'')); ?>">
                        <?php $__errorArgs = ['internship_position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="internship_start_date" id="internship_start_date" class="hrp-input Rectangle-29 date-picker" 
                               placeholder="dd/mm/yyyy" value="<?php echo e(old('internship_start_date', isset($letter)?optional($letter->internship_start_date)->format('d/m/Y'):null)); ?>" autocomplete="off">
                        <?php $__errorArgs = ['internship_start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="internship_end_date" id="internship_end_date" class="hrp-input Rectangle-29 date-picker" 
                               placeholder="dd/mm/yyyy" value="<?php echo e(old('internship_end_date', isset($letter)?optional($letter->internship_end_date)->format('d/m/Y'):null)); ?>" autocomplete="off">
                        <?php $__errorArgs = ['internship_end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="internship_address" id="internship_address" class="hrp-input Rectangle-29" rows="3" 
                             placeholder="Enter complete address"><?php echo e(old('internship_address', isset($letter)?$letter->internship_address:'')); ?></textarea>
                    <?php $__errorArgs = ['internship_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="internship_position" id="internship_letter_position" class="hrp-input Rectangle-29" 
                               placeholder="e.g., Developer" value="<?php echo e(old('internship_position', isset($letter)?$letter->internship_position:'')); ?>">
                        <?php $__errorArgs = ['internship_position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            <div id="warningFields" class="hidden col-span-2 space-y-4">
                <div>
                    ...
                    <textarea data-field="content" id="warning_content" class="form-control summernote-notes w-full" 
                             placeholder="Enter detailed warning content (e.g., specific issues, expected improvements, consequences)" style="min-height: 200px;"><?php echo e(old('content', isset($letter) && $letter->type == 'warning' ? $letter->content : '')); ?></textarea>
                    <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            <div id="otherFields" class="hidden col-span-2 space-y-4">
                <div>
                    ...
                    <input type="text" data-field="subject" id="other_subject" class="hrp-input Rectangle-29" 
                           placeholder="Enter letter subject" value="<?php echo e(old('subject', isset($letter) && $letter->type == 'other' ? $letter->subject : '')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea data-field="content" id="other_content" class="form-control summernote w-full" 
                             placeholder="Enter letter content" style="min-height: 300px;"><?php echo e(old('content', isset($letter) && $letter->type == 'other' ? $letter->content : '')); ?></textarea>
                    <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            <div id="universalFields" class="hidden col-span-2 space-y-4">
                <div>
                    ...
                    <input type="text" name="subject" id="universal_subject" class="hrp-input Rectangle-29" 
                           placeholder="Enter letter subject (optional)" value="<?php echo e(old('subject', isset($letter) ? $letter->subject : '')); ?>">
                    <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="content" id="universal_content" class="form-control summernote w-full" 
                             placeholder="Enter additional letter content (optional)" style="min-height: 250px;"><?php echo e(old('content', isset($letter) ? $letter->content : '')); ?></textarea>
                    <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            <div id="standardLetterFields">
                <div class="col-span-2 mt-4">
                    ...
                    <input type="text" name="notes" id="notes" class="hrp-input Rectangle-29" 
                           placeholder="Any additional notes about this letter" value="<?php echo e(old('notes', isset($letter)?$letter->notes:'')); ?>">
                    <?php $__errorArgs = ['notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            <div id="offerLetterFields" class="hidden md:col-span-2 space-y-4">
                <div class="p-6">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-200">
                            ...
                            <textarea name="probation_period" rows="4" class="hrp-textarea Rectangle-29 Rectangle-29-textarea" placeholder="Enter each point on new line"><?php echo e(old('probation_period', isset($letter)?$letter->probation_period:'')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <textarea name="salary_increment" rows="4" class="hrp-textarea Rectangle-29 Rectangle-29-textarea" placeholder="Enter each point on new line"><?php echo e(old('salary_increment', isset($letter)?$letter->salary_increment:'')); ?></textarea>
            ...
            <div class="md:col-span-2">
                <div class="hrp-actions">
                    <button type="submit" class="hrp-btn hrp-btn-primary" id="submitBtn">
                        <i class="fas fa-save mr-1"></i> <?php echo e(isset($letter) ? 'Update Letter' : 'Save Letter'); ?>
...
$(document).ready(function() {
    ...
    $('#generateRefBtn').click(function() {
        $.ajax({
            url: '<?php echo e(route("employees.letters.generate-reference")); ?>',
            type: 'GET',
    ...
    $(document).ready(function() {
        ...
        <?php if(isset($letter)): ?>
            const savedValue = '<?php echo e($letter->use_default_content ? "1" : "0"); ?>';
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/hr/employees/letters/create.blade.php ENDPATH**/ ?>