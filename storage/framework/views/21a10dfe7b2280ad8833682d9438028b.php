...
<div>
    ...
    <input 
        ...
        value="<?php echo e($formattedValue); ?>"
        class="date-input-field <?php echo e($class); ?> <?php $__errorArgs = [$name];
...
<link rel="stylesheet" href="<?php echo e(asset('css/date-input.css')); ?>?v=<?php echo e(time()); ?>">
...
</script><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/components/date-input.blade.php ENDPATH**/ ?>