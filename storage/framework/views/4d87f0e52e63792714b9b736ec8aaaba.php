...
<head>
    ...
    <title>Salary Slip - <?php echo e($payroll->employee->name); ?></title>
    <style>
        @page { 
            size: A4 portrait; 
            margin: 10mm 12mm;
...
<body>
    ...
    <div class="container">
        <div class="header">
            <div class="logo-box">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="Company Logo" onerror="this.style.display='none'">
            </div>
        ...
        <div class="slip-title">SALARY SLIP FOR <?php echo e(strtoupper($payroll->month)); ?> <?php echo e($payroll->year); ?></div>
        <div class="section-header">EMPLOYEE INFORMATION</div>
        <table class="info-table">
            <tr>
                <td>Employee Name</td>
                <td><strong style="color: #1e40af;"><?php echo e(strtoupper($payroll->employee->name)); ?></strong></td>
                <td>Employee Code</td>
                <td><?php echo e($payroll->employee->code ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td>Designation</td>
                <td><?php echo e($payroll->employee->position ?? 'N/A'); ?></td>
                <td>Email</td>
                <td><?php echo e($payroll->employee->email ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td>Date of Joining</td>
                <td><?php echo e($payroll->employee->joining_date ? \Carbon\Carbon::parse($payroll->employee->joining_date)->format('d-M-Y') : 'N/A'); ?></td>
                <td>Bank Name</td>
                <td><?php echo e($payroll->employee->bank_name ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td>Bank Account Number</td>
                <td><?php echo e($payroll->employee->bank_account_no ?? 'N/A'); ?></td>
                <td>IFSC Code</td>
                <td><?php echo e($payroll->employee->bank_ifsc ?? 'N/A'); ?></td>
            </tr>
        </table>
        <?php
        ...
        <table class="info-table">
            <tr>
                <td>Total Days in Month</td><td><?php echo e($daysInMonth); ?></td>
                <td>Actual Working Days</td><td><?php echo e($workingDays); ?></td>
            </tr>
            <tr>
                <td>Casual Leave (Paid)</td><td><?php echo e($casualLeave); ?></td>
                <td>Medical Leave (Paid)</td><td><?php echo e($medicalLeave); ?></td>
            </tr>
            <tr>
                <td>Personal Leave (Unpaid)</td><td><?php echo e($personalLeave); ?></td>
                <td>Total Paid Leave Days</td><td><?php echo e($paidLeaveDays); ?></td>
            </tr>
            <tr>
                <td>Per Day Salary</td><td>₹ <?php echo e(number_format($perDaySalary, 2)); ?></td>
                <td>Payable Days</td><td><?php echo e($daysInMonth - $personalLeave); ?></td>
            </tr>
        </table>
        ...
        <table class="salary-table">
            ...
            <tbody>
                <tr>
                    <td>Basic Salary</td>
                    <td class="amount"><?php echo e(number_format($payroll->basic_salary, 2)); ?></td>
                    <td>Provident Fund (PF)</td>
                    <td class="amount"><?php echo e(number_format($actualPf, 2)); ?></td>
                </tr>
                <tr>
                    <td>House Rent Allowance (HRA)</td>
                    <td class="amount"><?php echo e(number_format($actualHra, 2)); ?></td>
                    <td>Professional Tax (PT)</td>
                    <td class="amount"><?php echo e(number_format($actualProfessionalTax, 2)); ?></td>
                </tr>
                <tr>
                    <td>Medical Allowance</td>
                    <td class="amount"><?php echo e(number_format($actualMedicalAllowance, 2)); ?></td>
                    <td>Tax Deducted at Source (TDS)</td>
                    <td class="amount"><?php echo e(number_format($actualTds, 2)); ?></td>
                </tr>
                <tr>
                    <td>City Compensatory Allowance</td>
                    <td class="amount"><?php echo e(number_format($actualCityAllowance, 2)); ?></td>
                    <td>Employee State Insurance (ESIC)</td>
                    <td class="amount"><?php echo e(number_format($actualEsic, 2)); ?></td>
                </tr>
                <tr>
                    <td>Tiffin Allowance</td>
                    <td class="amount"><?php echo e(number_format($actualTiffinAllowance, 2)); ?></td>
                    <td>Security Deposit</td>
                    <td class="amount"><?php echo e(number_format($actualSecurityDeposit, 2)); ?></td>
                </tr>
                <tr>
                    <td>Assistant Allowance</td>
                    <td class="amount"><?php echo e(number_format($actualAssistantAllowance, 2)); ?></td>
                    <td>Leave Deduction (<?php echo e($personalLeave); ?> days)</td>
                    <td class="amount"><?php echo e(number_format($calculatedLeaveDeduction, 2)); ?></td>
                </tr>
                <tr>
                    <td>Dearness Allowance</td>
                    <td class="amount"><?php echo e(number_format($actualDearnessAllowance, 2)); ?></td>
                    <td>-</td>
                    <td class="amount">-</td>
                </tr>
                <tr>
                    <td>Special Bonus</td>
                    <td class="amount"><?php echo e(number_format($payroll->bonuses, 2)); ?></td>
                    <td>-</td>
                    <td class="amount">-</td>
                </tr>
                <tr class="total-row">
                    <td><strong>GROSS EARNINGS</strong></td>
                    <td class="amount"><?php echo e(number_format($grossEarnings, 2)); ?></td>
                    <td><strong>TOTAL DEDUCTIONS</strong></td>
                    <td class="amount"><?php echo e(number_format($totalDeductionsActual, 2)); ?></td>
                </tr>
                <tr class="net-salary-row">
                    <td colspan="3"><strong>NET SALARY (Take Home Salary)</strong></td>
                    <td class="amount"><?php echo e(number_format($calculatedNetSalary, 2)); ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="info-table">
            <tr>
                <td>Payment Date</td>
                <td><?php echo e($payroll->payment_date ? $payroll->payment_date->format('d-M-Y') : 'Not Paid Yet'); ?></td>
                <td>Payment Method</td>
                <td><?php echo e(strtoupper($payroll->payment_method ?? 'BANK TRANSFER')); ?></td>
            </tr>
            <tr>
                <td>Payment Status</td>
                <td><?php echo e(strtoupper($payroll->status)); ?></td>
        ...
        <div class="signatures">
            <div class="signature-box">
                ...
                <div style="font-size: 9pt; color: #6b7280;"><?php echo e($payroll->employee->name); ?></div>
            </div>
            <div class="signature-box">
                <div class="signature-line"></div>
...
</html><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/payroll/show.blade.php ENDPATH**/ ?>