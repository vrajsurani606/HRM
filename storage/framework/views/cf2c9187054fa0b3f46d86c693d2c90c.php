<?php $__env->startSection('page_title', 'Make Quotation'); ?>
...
<div class="hrp-card">
  <div class="Rectangle-30 hrp-compact">
    <form id="quotationForm" method="POST" action="<?php echo e(route('quotations.store')); ?>" enctype="multipart/form-data"
      class="hrp-form grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5">
      <?php echo csrf_field(); ?>
      <input type="hidden" name="inquiry_id" value="<?php echo e(isset($inquiry) ? $inquiry->id : ''); ?>">

      <!-- Row 1 -->
      <div>
        <label class="hrp-label">Unique Code</label>
        <div class="Rectangle-29" style="display: flex; align-items: center; background: #f3f4f6;">
          <?php echo e($nextCode ?? 'CMS/QUAT/0001'); ?>

          <input type="hidden" name="unique_code" value="<?php echo e($nextCode ?? 'CMS/QUAT/0001'); ?>">
        </div>
      </div>
      <div>
...
unset($__errorArgs, $__bag); ?>" name="quotation_title" placeholder="Enter your Title" value="<?php echo e(old('quotation_title')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="quotation_date" placeholder="dd/mm/yyyy" value="<?php echo e(old('quotation_date', date('d/m/Y'))); ?>" autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>" name="customer_type" id="customer_type" required>
            <option value="new" <?php echo e($customerType == 'new' ? 'selected' : ''); ?>>New Customer</option>
            <option value="existing" <?php echo e($customerType == 'existing' ? 'selected' : ''); ?>>Existing Customer</option>
          </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="lg:col-span-1 <?php echo e($customerType == 'existing' ? '' : 'hidden'); ?>" id="existing_customer_field">
...
unset($__errorArgs, $__bag); ?>" name="customer_id" id="customer_id" <?php echo e($customerType == 'existing' ? 'required' : ''); ?>>
            <option value="">Select Customer</option>
            <?php if(isset($companies)): ?>
              <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($company->id); ?>" <?php echo e($selectedCustomerId == $company->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="gst_no" placeholder="Enter GST No" value="<?php echo e(old('gst_no', $quotationData['gst_no'] ?? '')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="pan_no" placeholder="Enter PAN No" value="<?php echo e(old('pan_no')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="company_name" name="company_name" value="<?php echo e(old('company_name', $quotationData['company_name'] ?? '')); ?>" placeholder="Enter company name" required>
...
unset($__errorArgs, $__bag); ?>" name="nature_of_work" placeholder="Enter Nature" value="<?php echo e(old('nature_of_work')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="state">
            ...
            <option value="andhra_pradesh" <?php echo e(old('state') == 'andhra_pradesh' ? 'selected' : ''); ?>>Andhra Pradesh</option>
            <option value="arunachal_pradesh" <?php echo e(old('state') == 'arunachal_pradesh' ? 'selected' : ''); ?>>Arunachal Pradesh</option>
            ...
            <option value="himachal_pradesh" <?php echo e(old('state') == 'himachal_pradesh' ? 'selected' : ''); ?>>Himachal Pradesh</option>
            ...
            <option value="madhya_pradesh" <?php echo e(old('state') == 'madhya_pradesh' ? 'selected' : ''); ?>>Madhya Pradesh</option>
            ...
            <option value="tamil_nadu" <?php echo e(old('state') == 'tamil_nadu' ? 'selected' : ''); ?>>Tamil Nadu</option>
            <option value="telangana" <?php echo e(old('state') == 'telangana' ? 'selected' : ''); ?>>Telangana</option>
            <option value="uttar_pradesh" <?php echo e(old('state') == 'uttar_pradesh' ? 'selected' : ''); ?>>Uttar Pradesh</option>
            <option value="uttarakhand" <?php echo e(old('state') == 'uttarakhand' ? 'selected' : ''); ?>>Uttarakhand</option>
            <option value="west_bengal" <?php echo e(old('state') == 'west_bengal' ? 'selected' : ''); ?>>West Bengal</option>
...
unset($__errorArgs, $__bag); ?>" name="city">
            ...
            <option value="bengaluru" <?php echo e(old('city') == 'bengaluru' ? 'selected' : ''); ?>>Bengaluru</option>
            ...
            <option value="kolkata" <?php echo e(old('city') == 'kolkata' ? 'selected' : ''); ?>>Kolkata</option>
            <option value="surat" <?php echo e(old('city') == 'surat' ? 'selected' : ''); ?>>Surat</option>
            <option value="pune" <?php echo e(old('city') == 'pune' ? 'selected' : ''); ?>>Pune</option>
            <option value="jaipur" <?php echo e(old('city') == 'jaipur' ? 'selected' : ''); ?>>Jaipur</option>
            <option value="lucknow" <?php echo e(old('city') == 'lucknow' ? 'selected' : ''); ?>>Lucknow</option>
            <option value="kanpur" <?php echo e(old('city') == 'kanpur' ? 'selected' : ''); ?>>Kanpur</option>
            <option value="nagpur" <?php echo e(old('city') == 'nagpur' ? 'selected' : ''); ?>>Nagpur</option>
            <option value="indore" <?php echo e(old('city') == 'indore' ? 'selected' : ''); ?>>Indore</option>
            <option value="thane" <?php echo e(old('city') == 'thane' ? 'selected' : ''); ?>>Thane</option>
            <option value="bhopal" <?php echo e(old('city') == 'bhopal' ? 'selected' : ''); ?>>Bhopal</option>
            <option value="visakhapatnam" <?php echo e(old('city') == 'visakhapatnam' ? 'selected' : ''); ?>>Visakhapatnam</option>
            <option value="patna" <?php echo e(old('city') == 'patna' ? 'selected' : ''); ?>>Patna</option>
            <option value="vadodara" <?php echo e(old('city') == 'vadodara' ? 'selected' : ''); ?>>Vadodara</option>
            <option value="ghaziabad" <?php echo e(old('city') == 'ghaziabad' ? 'selected' : ''); ?>>Ghaziabad</option>
            <option value="ludhiana" <?php echo e(old('city') == 'ludhiana' ? 'selected' : ''); ?>>Ludhiana</option>
            <option value="agra" <?php echo e(old('city') == 'agra' ? 'selected' : ''); ?>>Agra</option>
            <option value="nashik" <?php echo e(old('city') == 'nashik' ? 'selected' : ''); ?>>Nashik</option>
            <option value="faridabad" <?php echo e(old('city') == 'faridabad' ? 'selected' : ''); ?>>Faridabad</option>
            <option value="meerut" <?php echo e(old('city') == 'meerut' ? 'selected' : ''); ?>>Meerut</option>
            <option value="rajkot" <?php echo e(old('city') == 'rajkot' ? 'selected' : ''); ?>>Rajkot</option>
            <option value="varanasi" <?php echo e(old('city') == 'varanasi' ? 'selected' : ''); ?>>Varanasi</option>
            <option value="srinagar" <?php echo e(old('city') == 'srinagar' ? 'selected' : ''); ?>>Srinagar</option>
            <option value="aurangabad" <?php echo e(old('city') == 'aurangabad' ? 'selected' : ''); ?>>Aurangabad</option>
            <option value="dhanbad" <?php echo e(old('city') == 'dhanbad' ? 'selected' : ''); ?>>Dhanbad</option>
            <option value="amritsar" <?php echo e(old('city') == 'amritsar' ? 'selected' : ''); ?>>Amritsar</option>
            <option value="navi_mumbai" <?php echo e(old('city') == 'navi_mumbai' ? 'selected' : ''); ?>>Navi Mumbai</option>
            <option value="ranchi" <?php echo e(old('city') == 'ranchi' ? 'selected' : ''); ?>>Ranchi</option>
            <option value="other" <?php echo e(old('city') == 'other' ? 'selected' : ''); ?>>Other</option>
          </select>
...
unset($__errorArgs, $__bag); ?>" name="scope_of_work" placeholder="Enter Scope" style="min-height:80px"><?php echo e(old('scope_of_work')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="address" placeholder="Enter Address" style="min-height:80px"><?php echo e(old('address', $quotationData['address'] ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="contact_person_1" placeholder="Enter Contact Person Name" value="<?php echo e(old('contact_person_1', $quotationData['contact_person'] ?? '')); ?>" required>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.phone-input','data' => ['name' => 'contact_number_1','label' => 'Contact Number 1','value' => old('contact_number_1', $quotationData['contact_number_1'] ?? ''),'required' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'contact_number_1','label' => 'Contact Number 1','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('contact_number_1', $quotationData['contact_number_1'] ?? '')),'required' => 'true']); ?>
...
unset($__errorArgs, $__bag); ?>" name="position_1" placeholder="Enter Position" value="<?php echo e(old('position_1')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="contract_details" placeholder="Enter Your Details" style="height:58px;resize:none;"><?php echo e(old('contract_details')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" type="email" name="company_email" id="company_email" value="<?php echo e(old('company_email', $quotationData['email'] ?? '')); ?>" placeholder="Add Mail-Id" required style="padding-right: 100px;">
...
unset($__errorArgs, $__bag); ?>" type="text" name="company_password" id="company_password" placeholder="Auto-generated password" value="<?php echo e(old('company_password')); ?>" style="padding-right: 100px;">
...
unset($__errorArgs, $__bag); ?>" type="email" name="company_employee_email" id="company_employee_email" placeholder="Auto-generated email (optional)" value="<?php echo e(old('company_employee_email')); ?>" style="padding-right: 100px;">
...
unset($__errorArgs, $__bag); ?>" type="text" name="company_employee_password" id="company_employee_password" placeholder="Auto-generated password (optional)" value="<?php echo e(old('company_employee_password')); ?>" style="padding-right: 100px;">
...
unset($__errorArgs, $__bag); ?>
      ...
      <input type="hidden" name="contract_amount" id="hidden_contract_amount" value="<?php echo e(old('contract_amount')); ?>">
  </div>
</div>
...
unset($__errorArgs, $__bag); ?>
    <?php $__errorArgs = ['services_1.description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><small class="hrp-error">Please fill all service descriptions</small><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
    <?php $__errorArgs = ['services_1.quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><small class="hrp-error">Please fill all service quantities</small><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
    <?php $__errorArgs = ['services_1.rate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><small class="hrp-error">Please fill all service rates</small><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
    ...
    <div style="margin-top: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px;">
      <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <input id="contract_amount" class="Rectangle-29" type="number" min="0" step="0.01" name="contract_amount" placeholder="Total Rate" style="width: 200px;" readonly value="<?php echo e(old('contract_amount')); ?>">
      </div>
    </div>
  </div>
</div>
...
<div class="Rectangle-30 hrp-compact">
  ...
  <div class="hrp-form grid grid-cols-1 md:grid-cols-5 gap-4 md:gap-5" style="margin: 30px 0;">
    <div>
      ...
      <input type="text" class="Rectangle-29 date-picker" name="amc_start_date" placeholder="dd/mm/yyyy" value="<?php echo e(old('amc_start_date')); ?>" autocomplete="off">
    </div>
    <div>
      <label class="hrp-label">AMC Amount:</label>
      <input class="Rectangle-29" name="amc_amount" placeholder="Enter Amount" value="<?php echo e(old('amc_amount')); ?>">
    </div>
    <div>
      <label class="hrp-label">Project Start Date:</label>
      <input type="text" class="Rectangle-29 date-picker" name="project_start_date" placeholder="dd/mm/yyyy" value="<?php echo e(old('project_start_date')); ?>" autocomplete="off">
    </div>
    <div>
      <label class="hrp-label">Completion Time:</label>
      <input class="Rectangle-29" name="completion_time" placeholder="Enter Time" value="<?php echo e(old('completion_time')); ?>">
    </div>
    <div>
      <label class="hrp-label">Retention Time:</label>
      <input class="Rectangle-29" name="retention_time" placeholder="Enter Time" value="<?php echo e(old('retention_time')); ?>">
    </div>

    <div>
      <label class="hrp-label">Retention Amount:</label>
      <input id="retention_amount" class="Rectangle-29" name="retention_amount" placeholder="Enter Amount" readonly value="<?php echo e(old('retention_amount')); ?>">
    </div>
    <div>
      <label class="hrp-label">Retention %:</label>
      <input class="Rectangle-29" id="retention_percent" name="retention_percent" type="number" min="0" max="100" step="0.1" placeholder="Enter %" oninput="calculateRetentionAmount()" value="<?php echo e(old('retention_percent')); ?>">
    </div>
    <div>
      <label class="hrp-label">Tentative Complete Date:</label>
      <input type="text" class="Rectangle-29 date-picker" name="tentative_complete_date" placeholder="dd/mm/yyyy" value="<?php echo e(old('tentative_complete_date')); ?>" autocomplete="off">
    </div>
    <div></div>
    <div></div>
    <div></div>
...
<div class="Rectangle-30 hrp-compact">
  ...
  <div class="hrp-form grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5" style="margin: 30px 0;">
    ...
    <div>
      ...
      <input class="Rectangle-29" name="prepared_by" placeholder="Enter Name" value="<?php echo e(old('prepared_by')); ?>">
      <?php $__errorArgs = ['prepared_by'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><small class="hrp-error"><?php echo e($message); ?></small><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      <?php if (isset($component)) { $__componentOriginal7f129feca299ac4c0aa6a1d3bbb99a8a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7f129feca299ac4c0aa6a1d3bbb99a8a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.phone-input','data' => ['class' => 'Rectangle-29','name' => 'mobile_no','label' => 'Mobile No.','value' => old('mobile_no')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('phone-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'Rectangle-29','name' => 'mobile_no','label' => 'Mobile No.','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('mobile_no'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal7f129feca299ac4c0aa6a1d3bbb99a8a)): ?>
<?php $attributes = $__attributesOriginal7f129feca299ac4c0aa6a1d3bbb99a8a; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    //
    <?php if(old('services_1')): ?>
        const services1Data = <?php echo json_encode(old('services_1'), 15, 512) ?>;
    ...
    <?php if(old('services_2')): ?>
        const services2Data = <?php echo json_encode(old('services_2'), 15, 512) ?>;
    ...
    <?php if(old('basic_cost')): ?>
        const basicCostData = <?php echo json_encode(old('basic_cost'), 15, 512) ?>;
    ...
    <?php if(old('additional_cost')): ?>
        const additionalCostData = <?php echo json_encode(old('additional_cost'), 15, 512) ?>;
    ...
    <?php if(old('maintenance_cost')): ?>
        const maintenanceCostData = <?php echo json_encode(old('maintenance_cost'), 15, 512) ?>;
    ...
    <?php if(old('features')): ?>
        const selectedFeatures = <?php echo json_encode(old('features'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/quotations/create.blade.php ENDPATH**/ ?>