...
unset($__errorArgs, $__bag); ?>" name="gst_no" placeholder="Enter GST No" value="<?php echo e(old('gst_no', $quotationData['gst_no'] ?? '')); ?>" style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase()">
...
unset($__errorArgs, $__bag); ?>" name="pan_no" placeholder="Enter PAN No" value="<?php echo e(old('pan_no')); ?>" style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase()">
...
unset($__errorArgs, $__bag); ?>" name="state" id="state_select">
            ...
            <option value="jammu_kashmir" <?php echo e(old('state') == 'jammu_kashmir' ? 'selected' : ''); ?>>Jammu & Kashmir</option>
...
unset($__errorArgs, $__bag); ?>" name="city" id="city_select">
          ...
          <input type="hidden" id="old_city" value="<?php echo e(old('city')); ?>">
