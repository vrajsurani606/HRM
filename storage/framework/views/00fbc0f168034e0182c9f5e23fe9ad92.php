...
<?php $__env->startSection('page_title', 'Customer Dashboard'); ?>
...
<div class="hrp-grid" style="padding:14px">
  ...
  <div class="hrp-col-12">
    <div style="background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); border-radius: 16px; padding: 32px; color: white; box-shadow: 0 4px 16px rgba(99, 102, 241, 0.3);">
      <h2 style="font-size: 28px; font-weight: 700; margin: 0 0 8px 0;">Welcome back, <?php echo e(auth()->user()->name); ?>!</h2>
      <p style="font-size: 16px; opacity: 0.9; margin: 0;"><?php echo e($company->company_name); ?> - Here's an overview of your account and recent activity</p>
    </div>
  </div>
  <?php else: ?>
  <div class="hrp-col-12">
  ...
  <div class="hrp-col-3">
    <div class="cust-kpi-card indigo">
      ...
      <div class="cust-kpi-value"><?php echo e($stats['total_quotations']); ?></div>
  ...
  <div class="hrp-col-3">
    <div class="cust-kpi-card amber">
      ...
      <div class="cust-kpi-value"><?php echo e($stats['pending_quotations']); ?></div>
  ...
  <div class="hrp-col-3">
    <div class="cust-kpi-card sky">
      ...
      <div class="cust-kpi-value"><?php echo e($stats['total_invoices']); ?></div>
  ...
  <div class="hrp-col-3">
    <div class="cust-kpi-card rose">
      ...
      <div class="cust-kpi-value"><?php echo e($stats['pending_payments']); ?></div>
  ...
  <div class="hrp-col-3">
    <div class="cust-kpi-card emerald">
      ...
      <div class="cust-kpi-value"><?php echo e($stats['total_projects']); ?></div>
  ...
  <div class="hrp-col-3">
    <div class="cust-kpi-card violet">
      ...
      <div class="cust-kpi-value"><?php echo e($stats['active_projects']); ?></div>
  ...
  <div class="hrp-col-3">
    <div class="cust-kpi-card teal">
      ...
      <div class="cust-kpi-value"><?php echo e($stats['open_tickets']); ?></div>
  ...
  <div class="hrp-col-3">
    <div class="cust-kpi-card fuchsia">
      ...
      <div class="cust-kpi-value">$<?php echo e($stats['total_spent']); ?></div>
  ...
  <div class="hrp-col-6">
    <div class="cust-doc-card">
      ...
      <div>
        <?php $__empty_1 = true; $__currentLoopData = $recentQuotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div class="cust-doc-item">
            <div class="cust-doc-info">
              <div class="cust-doc-number"><?php echo e($quot['number']); ?></div>
              <div class="cust-doc-details"><?php echo e($quot['date']); ?> • Valid until: <?php echo e($quot['valid_until']); ?></div>
            </div>
            <div class="cust-doc-amount">$<?php echo e($quot['amount']); ?></div>
            <span class="cust-doc-badge <?php echo e($quot['status']); ?>"><?php echo e(ucfirst($quot['status'])); ?></span>
          </div>
    ...
    <div class="cust-doc-card">
      ...
      <div>
        <?php $__empty_1 = true; $__currentLoopData = $recentInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div class="cust-doc-item">
            <div class="cust-doc-info">
              <div class="cust-doc-number"><?php echo e($inv['number']); ?></div>
              <div class="cust-doc-details"><?php echo e($inv['date']); ?> • Due: <?php echo e($inv['due_date']); ?></div>
            </div>
            <div class="cust-doc-amount">$<?php echo e($inv['amount']); ?></div>
            <span class="cust-doc-badge <?php echo e($inv['status']); ?>"><?php echo e(ucfirst($inv['status'])); ?></span>
          </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
          <div class="cust-doc-item">
            <div class="cust-doc-info">
  ...
  <div class="hrp-col-12">
    <div style="background: white; border-radius: 16px; padding: 24px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); margin-bottom: 12px;">
      ...
      <div class="hrp-grid">
        <?php $__empty_1 = true; $__currentLoopData = $activeProjectsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div class="hrp-col-6">
            <a href="<?php echo e(route('projects.overview', $project['id'])); ?>" style="text-decoration: none; color: inherit; display: block;">
              <div class="cust-project-card" style="cursor: pointer; transition: all 0.3s ease;">
                <div class="cust-project-header">
                  <div class="cust-project-name"><?php echo e($project['name']); ?></div>
                  <span class="cust-project-status"><?php echo e(ucfirst($project['status'])); ?></span>
                </div>
                <div class="cust-project-dates">
                  📅 <?php echo e($project['start_date']); ?> → <?php echo e($project['end_date']); ?>
                ...
                <div class="cust-project-progress">
                  ...
                  <div class="cust-progress-bar">
                    <div class="cust-progress-fill" style="width: <?php echo e($project['progress']); ?>%"></div>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/dashboard-customer.blade.php ENDPATH**/ ?>