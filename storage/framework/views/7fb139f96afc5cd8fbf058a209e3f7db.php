...
<?php $__env->startSection('content'); ?>
      ...
      <div style="background: #f9fafb; padding: 25px 40px; display: flex; flex-direction: column; align-items: center;">
        ...
        <div style="display: flex; flex-direction: column; gap: 0px; max-width: 600px; width: 100%;">
          <div style="display: flex; align-items: center; padding: 8px 0px;">
            ...
            <span style="color: #1f2937; width: 30px; text-align: center; font-weight: 600;">:</span>
            <span style="color: #4b5563; font-weight: 400; text-align: left; flex: 1; font-size: 14px;"><?php echo e($company->person_name_1 ? $company->person_name_1 : 'Undefined'); ?></span>
          </div>
          <div style="display: flex; align-items: center; padding: 8px 0px;">
            <span style="color: #000; font-weight: 600; width: 220px; text-align: left; font-size: 14px;">Person Number</span>
            <span style="color: #1f2937; width: 30px; text-align: center; font-weight: 600;">:</span>
            <span style="color: #4b5563; font-weight: 400; text-align: left; flex: 1; font-size: 14px;"><?php echo e($company->person_number_1 ? $company->person_number_1 : 'Undefined'); ?></span>
          </div>
          <div style="display: flex; align-items: center; padding: 8px 0px;">
            <span style="color: #000; font-weight: 600; width: 220px; text-align: left; font-size: 14px;">Person Position</span>
            <span style="color: #1f2937; width: 30px; text-align: center; font-weight: 600;">:</span>
            <span style="color: #4b5563; font-weight: 400; text-align: left; flex: 1; font-size: 14px;"><?php echo e($company->person_position_1 ? $company->person_position_1 : 'Undefined'); ?></span>
          </div>
          <div style="display: flex; align-items: center; padding: 8px 0px;">
            <span style="color: #000; font-weight: 600; width: 220px; text-align: left; font-size: 14px;">Person Name</span>
            <span style="color: #1f2937; width: 30px; text-align: center; font-weight: 600;">:</span>
            <span style="color: #4b5563; font-weight: 400; text-align: left; flex: 1; font-size: 14px;"><?php echo e($company->person_name_2 ? $company->person_name_2 : 'Undefined'); ?></span>
          </div>
          <div style="display: flex; align-items: center; padding: 8px 0px;">
            <span style="color: #000; font-weight: 600; width: 220px; text-align: left; font-size: 14px;">Person Number</span>
            <span style="color: #1f2937; width: 30px; text-align: center; font-weight: 600;">:</span>
            <span style="color: #4b5563; font-weight: 400; text-align: left; flex: 1; font-size: 14px;"><?php echo e($company->person_number_2 ? $company->person_number_2 : 'Undefined'); ?></span>
          </div>
          <div style="display: flex; align-items: center; padding: 8px 0px;">
            <span style="color: #000; font-weight: 600; width: 220px; text-align: left; font-size: 14px;">Person Position</span>
            <span style="color: #1f2937; width: 30px; text-align: center; font-weight: 600;">:</span>
            <span style="color: #4b5563; font-weight: 400; text-align: left; flex: 1; font-size: 14px;"><?php echo e($company->person_position_2 ? $company->person_position_2 : 'Undefined'); ?></span>
          </div>
          <div style="display: flex; align-items: center; padding: 8px 0px;">
            <span style="color: #000; font-weight: 600; width: 220px; text-align: left; font-size: 14px;">Person Name</span>
            <span style="color: #1f2937; width: 30px; text-align: center; font-weight: 600;">:</span>
            <span style="color: #4b5563; font-weight: 400; text-align: left; flex: 1; font-size: 14px;"><?php echo e($company->person_name_3 ? $company->person_name_3 : 'Undefined'); ?></span>
          </div>
          <div style="display: flex; align-items: center; padding: 8px 0px;">
            <span style="color: #000; font-weight: 600; width: 220px; text-align: left; font-size: 14px;">Person Number</span>
            <span style="color: #1f2937; width: 30px; text-align: center; font-weight: 600;">:</span>
            <span style="color: #4b5563; font-weight: 400; text-align: left; flex: 1; font-size: 14px;"><?php echo e($company->person_number_3 ? $company->person_number_3 : 'Undefined'); ?></span>
          </div>
          <div style="display: flex; align-items: center; padding: 10px 12px;">
            <span style="color: #000; font-weight: 600; width: 220px; text-align: left; font-size: 14px;">Person Position</span>
            <span style="color: #1f2937; width: 30px; text-align: center; font-weight: 600;">:</span>
            <span style="color: #4b5563; font-weight: 400; text-align: left; flex: 1; font-size: 14px;"><?php echo e($company->person_position_3 ? $company->person_position_3 : 'Undefined'); ?></span>
          </div>
        </div>
      </div>
    </div>
            ...
            <?php if($company->sop_upload): ?>
              ...
              <?php else: ?>
                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; color: #666;">
                  ...
                  <span style="font-size: 12px;"><?php echo e(strtoupper($extension)); ?></span>
                </div>
              <?php endif; ?>
            <?php else: ?>
              <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; color: #666;">
    ...
    <div id="company-tabs" style="margin-bottom: 20px; padding: 0 20px;">
      <div style="display: flex; align-items: center; gap: 0px; overflow-x: auto; padding: 15px 20px; background: #F0F0F0; margin-bottom: 20px;">
        <button class="tab-button" style="background: transparent; color: <?php echo e($activeTab==='quotation' ? '#000' : '#6b7280'); ?>; border: none; padding: 0px; font-size: 14px; cursor: pointer; font-weight: <?php echo e($activeTab==='quotation' ? '600' : '400'); ?>;" data-tab="quotation">🗂️ Quotation List</button>
        <span style="color: #9ca3af; margin: 0 12px;">|</span>
        <button class="tab-button" style="background: transparent; color: <?php echo e($activeTab==='template' ? '#000' : '#6b7280'); ?>; border: none; padding: 0px; font-size: 14px; cursor: pointer; font-weight: <?php echo e($activeTab==='template' ? '600' : '400'); ?>;" data-tab="template">📋 Template List</button>
        <span style="color: #9ca3af; margin: 0 12px;">|</span>
        <button class="tab-button" style="background: transparent; color: <?php echo e($activeTab==='proforma' ? '#000' : '#6b7280'); ?>; border: none; padding: 0px; font-size: 14px; cursor: pointer; font-weight: <?php echo e($activeTab==='proforma' ? '600' : '400'); ?>;" data-tab="proforma">📄 Proforma Mana.</button>
        <span style="color: #9ca3af; margin: 0 12px;">|</span>
        <button class="tab-button" style="background: transparent; color: <?php echo e($activeTab==='invoice' ? '#000' : '#6b7280'); ?>; border: none; padding: 0px; font-size: 14px; cursor: pointer; font-weight: <?php echo e($activeTab==='invoice' ? '600' : '400'); ?>;" data-tab="invoice">🧾 Invoice Mana.</button>
        <span style="color: #9ca3af; margin: 0 12px;">|</span>
        <button class="tab-button" style="background: transparent; color: <?php echo e($activeTab==='receipt' ? '#000' : '#6b7280'); ?>; border: none; padding: 0px; font-size: 14px; cursor: pointer; font-weight: <?php echo e($activeTab==='receipt' ? '600' : '400'); ?>;" data-tab="receipt">🧾 The Receipt</button>
        <span style="color: #9ca3af; margin: 0 12px;">|</span>
        <button class="tab-button" style="background: transparent; color: <?php echo e($activeTab==='ticket' ? '#000' : '#6b7280'); ?>; border: none; padding: 0px; font-size: 14px; cursor: pointer; font-weight: <?php echo e($activeTab==='ticket' ? '600' : '400'); ?>;" data-tab="ticket">🎫 Ticket</button>
      </div>
      ...
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Companies Management.edit company')): ?>
        <a href="<?php echo e(route('companies.edit', $company->unique_code)); ?>" style="background: #3b82f6; color: white; border: none; padding: 8px 16px; border-radius: 6px; font-size: 14px; cursor: pointer; display: flex; align-items: center; gap: 5px; text-decoration: none;">
      ...
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Companies Management.delete company')): ?>
        <form action="<?php echo e(route('companies.destroy', $company->unique_code)); ?>" method="POST" style="display: inline;">
          <?php echo csrf_field(); ?>
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
              <tr style="border-bottom: 1px solid #f3f4f6;">
                <td style="padding: 12px;">
                  <div style="display: flex; gap: 8px; align-items: center;">
                    <img src="<?php echo e(asset('action_icon/completed.svg')); ?>" alt="completed" style="width: 20px; height: 20px;">
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #f3f4f6;">
                <td style="padding: 12px;">
                  <div style="display: flex; gap: 8px; align-items: center;">
                    <img src="<?php echo e(asset('action_icon/pending.svg')); ?>" alt="pending" style="width: 20px; height: 20px;">
                  </div>
                </td>
                ...
                <td style="padding: 12px;">
                  <div style="display: flex; gap: 8px; align-items: center;">
                    <div style="width: 24px; height: 24px; border-radius: 4px; display: flex; align-items: center; justify-content: center; cursor: pointer;" title="Edit">
                      <img src="<?php echo e(asset('action_icon/edit.svg')); ?>" alt="edit" style="width: 14px; height: 14px;">
                    </div>
                  </div>
                </td>
              </tr>
                ...
                <td style="padding: 12px;">
                  <div style="display: flex; gap: 8px; align-items: center;">
                    <div style="width: 24px; height: 24px;border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer;" title="Generate">
                      <img src="<?php echo e(asset('action_icon/generate.svg')); ?>" alt="generate" style="width: 14px; height: 14px;">
                    </div>
                    <div style="width: 24px; height: 24px;border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer;" title="Convert">
                      <img src="<?php echo e(asset('action_icon/convert.svg')); ?>" alt="convert" style="width: 14px; height: 14px;">
                    </div>
                    <div style="width: 24px; height: 24px; border-radius: 4px; display: flex; align-items: center; justify-content: center; cursor: pointer;" title="Edit">
                      <img src="<?php echo e(asset('action_icon/edit.svg')); ?>" alt="edit" style="width: 14px; height: 14px;">
                    </div>
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
              <tr style="border-bottom: 1px solid #f3f4f6;">
                <td style="padding: 12px; color: #374151;">1</td>
                <td style="padding: 12px;">
                  <img src="<?php echo e(asset('action_icon/edit.svg')); ?>" alt="edit" style="width: 16px; height: 16px; cursor: pointer;">
                </td>
                <td style="padding: 12px; color: #374151;">CEI/INV/001</td>
                <td style="padding: 12px; color: #374151;">25/09/2025</td>
                <td style="padding: 12px; color: #374151;">2</td>
              ...
              <tr style="border-bottom: 1px solid #f3f4f6;">
                ...
                <td style="padding: 12px;">
                  <div style="display: flex; gap: 4px; align-items: center;">
                    <div style="width: 24px; height: 24px;border-radius: 4px; display: flex; align-items: center; justify-content: center; cursor: pointer;" title="Edit">
                      <img src="<?php echo e(asset('action_icon/show.svg')); ?>" alt="edit" style="width: 14px; height: 14px;">
                    </div>

                    <img src="<?php echo e(asset('action_icon/delete.svg')); ?>" alt="delete" style="width: 16px; height: 16px; cursor: pointer;">
                  </div>
                </td>
