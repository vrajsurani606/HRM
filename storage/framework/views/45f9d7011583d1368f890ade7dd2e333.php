...
<head>
    ...
    <title>Proforma Invoice - <?php echo e($proforma->unique_code); ?></title>
    <style>
        :root {
    ...
    <div class="page">
        ...
        <div class="content">
            ...
            <div class="header-info">
                <p><strong>Date:</strong> <?php echo e($proforma->proforma_date ? $proforma->proforma_date->format('d-m-Y') : date('d-m-Y')); ?></p>
                <p><strong>Proforma No.:</strong> <?php echo e($proforma->unique_code); ?></p>
            </div>
            ...
            <div class="parties-section">
                ...
                <div class="party-column">
                    ...
                    <div class="party-details">
                        <p><strong><?php echo e(strtoupper($proforma->company_name)); ?></strong></p>
                        <?php if($proforma->address): ?>
                        <p><?php echo e($proforma->address); ?></p>
                        <?php endif; ?>
                        <?php if($proforma->gst_no): ?>
                        <p>GST. NO.: <?php echo e($proforma->gst_no); ?></p>
                        <?php endif; ?>
                        <?php if($proforma->mobile_no): ?>
                        <p>Mo. <?php echo e($proforma->mobile_no); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <table class="items-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo e($sacCodes[$i] ?? 'df'); ?></td>
            ...
            <div class="summary-section">
                ...
                <div class="summary-right">
                    <table class="totals-table">
                        ...
                        <tr>
                            <td>Discount (<?php echo e($proforma->discount_percent); ?>%)</td>
                            <td>₹<?php echo e(number_format($proforma->discount_amount, 2)); ?></td>
                        </tr>
                        <?php endif; ?>
                        <?php if(isset($proforma->retention_amount) && $proforma->retention_amount > 0): ?>
                        <tr>
                            <td>Retention (<?php echo e(number_format($proforma->retention_percent ?? 0, 2)); ?>%)</td>
                            <td>₹<?php echo e(number_format($proforma->retention_amount, 2)); ?></td>
                        </tr>
                        <?php endif; ?>
                        <?php if($proforma->cgst_amount > 0): ?>
                        <tr>
                            <td>CGST (<?php echo e($proforma->cgst_percent); ?>%)</td>
                            <td>₹<?php echo e(number_format($proforma->cgst_amount, 2)); ?></td>
                        </tr>
                        <?php endif; ?>
                        <?php if($proforma->sgst_amount > 0): ?>
                        <tr>
                            <td>SGST (<?php echo e($proforma->sgst_percent); ?>%)</td>
                            <td>₹<?php echo e(number_format($proforma->sgst_amount, 2)); ?></td>
                        </tr>
                        <?php endif; ?>
                    ...
                    <div class="balance-due-box">
                        ...
                        <div class="amount">₹<?php echo e(number_format($proforma->final_amount ?? 0, 2)); ?> /-</div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/performas/print.blade.php ENDPATH**/ ?>