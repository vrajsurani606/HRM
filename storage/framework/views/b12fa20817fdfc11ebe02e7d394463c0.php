<?php $__env->startSection('page_title', 'Events Management'); ?>
...
<div class="events-page">
  ...
  <div class="events-header">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Events Management.create event')): ?>
      <button class="add-event-btn" data-toggle="modal" data-target="#addEventModal">
        <img src="<?php echo e(asset('action_icon/pluse.svg')); ?>" alt="Add" class="btn-icon"> Add
      </button>
    <?php endif; ?>
  </div>
  ...
  <div class="events-grid" id="eventsGrid">
    <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      ...
      ?>
      <div class="event-card" data-event-id="<?php echo e($event->id); ?>" data-has-cover="<?php echo e($cover ? '1' : '0'); ?>">
        <?php if($cover): ?>
          <img src="<?php echo e($cover); ?>" alt="<?php echo e($event->name); ?>" class="event-image">
        <?php else: ?>
          <div class="event-image" style="display:flex;align-items:center;justify-content:center;background:#f3f4f6;color:#9ca3af;font-weight:800;font-size:48px;"><?php echo e($initial); ?></div>
        <?php endif; ?>
        <div class="event-content">
          <div class="event-title" title="<?php echo e($event->name); ?>"><?php echo e(\Illuminate\Support\Str::limit($event->name, 24)); ?></div>
          <div class="event-date"><?php echo e($event->created_at?->format('M d, Y')); ?></div>
        </div>
        <div class="event-actions">
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Events Management.upload event image')): ?>
          <button class="action-btn js-upload" data-id="<?php echo e($event->id); ?>" title="Upload Images">
            <!-- upload icon -->
          ...
          <?php endif; ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Events Management.edit event')): ?>
          <button class="action-btn js-edit" data-id="<?php echo e($event->id); ?>" data-name="<?php echo e($event->name); ?>" data-description="<?php echo e($event->description); ?>" data-cover="<?php echo e($cover); ?>" title="Edit">
            <img src="<?php echo e(asset('action_icon/edit.svg')); ?>" alt="Edit">
          </button>
          <?php endif; ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Events Management.view event')): ?>
          <a href="<?php echo e(route('events.show', $event)); ?>" class="action-btn view" title="View">
            <img src="<?php echo e(asset('action_icon/view.svg')); ?>" alt="View">
          </a>
          <?php endif; ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Events Management.delete event')): ?>
        ...
        <div class="event-footer">
          <div class="count-pills">
            <a class="count-pill" href="<?php echo e(route('events.show', $event)); ?>?filter=image" title="View photos">
            ...
            <a class="count-pill" href="<?php echo e(route('events.show', $event)); ?>?filter=video" title="View videos">
          ...
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Events Management.view event')): ?>
            <a href="<?php echo e(route('events.show', $event)); ?>" class="pill-btn" style="padding:6px 10px; font-weight:700;">Open</a>
          <?php endif; ?>
        </div>
      </div>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group" style="margin-bottom:0;">
            ...
            <textarea name="description" class="form-control form-textarea" placeholder="Enter description"><?php echo e(old('description')); ?></textarea>
...
<script>
  ...
  const baseUploadUrl = "<?php echo e(url('events')); ?>";
  const baseEventsUrl = "<?php echo e(url('events')); ?>";
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/events/index.blade.php ENDPATH**/ ?>