...
<head>
  ...
  <title>Offer Letter - <?php echo e($lead->person_name); ?></title>
  <style>
...
<body>
  ...
  <div class="offer-container">
    ...
    <div class="letter-content first-page">
      <div style="margin-bottom: 15px;"><b>Ref No.:</b> <?php echo e($offer->reference_number ?? $lead->unique_code ?? 'N/A'); ?></div>
      <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 16px;">
        <div class="recipient" style="flex: 1;">
          <div><b>To,</b></div>
          <div><?php echo e(($lead->gender == 'Female' || $lead->gender == 'female') ? 'Ms.' : 'Mr.'); ?> <?php echo e($lead->person_name ?? $lead->name); ?></div>
          <div><?php echo e($lead->position ?? $lead->designation ?? 'Candidate'); ?></div>
          <?php if(!empty($lead->address)): ?>
          <div><?php echo e($lead->address); ?></div>
          <?php endif; ?>
        </div>
        <div class="letter-meta" style="text-align: right;">
          <div><b>Date:</b> <?php echo e(optional($offer->issue_date)->format('d-m-Y') ?? now()->format('d-m-Y')); ?></div>
        </div>
      </div>
      <div class="subject">Subject: Job Offer for <?php echo e($lead->position ?? $lead->designation ?? 'N/A'); ?> Position</div>
      <div class="body">
        <p>Dear <b><?php echo e($lead->person_name ?? $lead->name); ?></b>,</p>
        <p><b>Congratulations!</b> We are pleased to inform you that you have been selected to join <span class="company"><?php echo e($company_name); ?></span><br> as a <span class="highlight"><?php echo e($lead->position ?? $lead->designation ?? 'N/A'); ?></span>. We are delighted to extend the following job offer:</p>
        <ol style="margin-top:-0px;">
          <li><b>Position & Compensation</b>
            <ul style="list-style-type: disc;">
              <li><b>Designation:</b> <?php echo e($lead->position ?? $lead->designation ?? 'N/A'); ?></li>
              <li><b>Monthly Salary:</b> ₹ <?php echo e($offer->monthly_salary ? number_format($offer->monthly_salary, 2) : '__________'); ?></li>
              <li><b>Annual Cost to Company (CTC):</b> ₹ <?php echo e($offer->annual_ctc ? number_format($offer->annual_ctc, 2) : '__________'); ?></li>
              <li><b>Reporting Manager:</b> <?php echo e($offer->reporting_manager ?? '__________'); ?></li>
              <li><b>Working Hours:</b> <?php echo e($offer->working_hours ?? '9:30 AM to 6:30 PM'); ?></li>
            </ul>
          </li>
          <li><b>Probation Period</b>
            <?php if(!empty($probation_lines)): ?>
              <ul class="bullets-avoid-break" style="list-style: disc; margin: 4px 0 0 18px; padding:0;">
                <?php $__currentLoopData = $probation_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ln): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li style="margin-bottom:2px;"><?php echo e($ln); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            <?php endif; ?>
          </li>
          <li><b>Salary & Increment Structure (Special Case)</b>
            <?php if(!empty($salary_lines)): ?>
              <ul class="bullets-avoid-break" style="list-style: disc; margin: 4px 0 0 18px; padding:0;">
                <?php $__currentLoopData = $salary_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ln): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li style="margin-bottom:2px;"><?php echo e($ln); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            <?php endif; ?>
        ...
        <p style="margin-top:-0px;">
          ...
          <b><?php echo e(data_get($joining, 'date_of_joining', '[Date of Joining]')); ?></b>
          at 9:30 AM. Please report to  <b><?php echo e(data_get($joining, 'reporting_person', 'Reporting person name')); ?></b> 
          for documentation and orientation. If this date is not feasible, kindly inform us immediately.
        </p>
        <p style="margin-top:5px;">We are confident that you will make a valuable contribution to the success of <span class="company"><?php echo e($company_name); ?></span> and look forward to working with you.</p>
      </div>
      <div class="signature">
...
<?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/hr/hiring/print_offerletter.blade.php ENDPATH**/ ?>