<?php $__env->startSection('page_title', 'Bulk Salary Generator'); ?>
...
<div class="hrp-card">
  <div class="Rectangle-30 hrp-compact">
    ...
    <form method="POST" action="<?php echo e(route('payroll.bulk-generate')); ?>" id="bulkSalaryForm">
      <?php echo csrf_field(); ?>
          ...
          <div class="form-field">
            ...
            <select name="month" id="month" class="Rectangle-29 Rectangle-29-select" required>
              ...
              <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($m); ?>" <?php echo e($m == date('F') ? 'selected' : ''); ?>><?php echo e($m); ?></option>
      ...
      <div class="step-card">
        ...
        <div class="employee-box">
          ...
          <div class="checkbox-card" onclick="document.getElementById('all_employees').click();">
            ...
            <span class="checkbox-badge"><?php echo e($employees->count()); ?> Total</span>
          </div>
            ...
            <div class="employee-left">
              ...
              <select name="employee_ids[]" id="employee_ids" class="employee-list-box" multiple size="15" disabled>
                <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($emp->id); ?>"><?php echo e($emp->name); ?> (<?php echo e($emp->code); ?>) - ₹<?php echo e(number_format($emp->current_offer_amount ?? 0, 0)); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="employee-right">
              ...
              <div class="info-card">
                ...
                <div class="info-card-item">
                  ...
                  <span class="info-card-value" id="selected_count"><?php echo e($employees->count()); ?></span>
                </div>
                <div class="info-card-item">
                  <span class="info-card-label">Total Employees</span>
                  <span class="info-card-value"><?php echo e($employees->count()); ?></span>
                </div>
              </div>
      ...
      <div class="action-bar">
        ...
        <a href="<?php echo e(route('payroll.index')); ?>" class="hrp-btn" style="background:#e5e7eb; color:#111827;">
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/payroll/bulk.blade.php ENDPATH**/ ?>