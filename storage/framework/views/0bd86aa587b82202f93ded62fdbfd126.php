  ...
  <div class="hrp-card">
    <div class="Rectangle-30 hrp-compact">
      <div class="hrp-actions" style="justify-content: space-between; padding: 0 4px 10px;">
        <div class="hrp-label" style="margin:0">Edit Role: <?php echo e($role->name); ?></div>
<a href="<?php echo e(route('roles.index')); ?>" class="pill-btn back-btn" title="Back to Roles">
      ...
      <form action="<?php echo e(route('roles.update', $role)); ?>" method="POST" class="grid grid-cols-1 gap-3">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            <label class="hrp-label">Name<span style="color:#ef4444"> *</span></label>
            <input type="text" name="name" value="<?php echo e(old('name', $role->name)); ?>" placeholder="Enter Role Name" class="hrp-input Rectangle-29" required>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div>
            ...
            <textarea name="description" rows="1" placeholder="Role description" class="hrp-textarea Rectangle-29 Rectangle-29-textarea"><?php echo e(old('description', $role->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="permissions-panel">
          ...
          <div class="perm-accordion">
            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $modulePermissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="perm-item" data-module="<?php echo e($module); ?>">
                <div class="perm-head">
                  <div class="perm-toggle" aria-expanded="true" style="pointer-events:none">
                    <span class="title"><?php echo e(ucfirst($module)); ?></span>
                  </div>
                  <div class="perm-head-right">
                    <span class="perm-count" data-module="<?php echo e($module); ?>">0/0 selected</span>
                    <label class="custom-checkbox perm-select-all" style="margin:0">
                      <input type="checkbox" class="module-checkbox" data-module="<?php echo e($module); ?>">
                      <div class="checkbox-box"><span class="checkmark">✓</span></div>
                      Select all
                    </label>
                  </div>
                  ...
                  <div class="perm-grid">
                    <?php $__currentLoopData = $modulePermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <label class="custom-checkbox">
                        <input type="checkbox" class="permission-checkbox" name="permissions[]" value="<?php echo e($permission->name); ?>" id="permission_<?php echo e($permission->id); ?>" data-module="<?php echo e($module); ?>" <?php echo e(in_array($permission->name, old('permissions', $rolePermissions)) ? 'checked' : ''); ?>>
                        <div class="checkbox-box"><span class="checkmark">✓</span></div>
                        <?php echo e(ucwords(str_replace('_',' ', explode('.', $permission->name)[1]))); ?>
        ...
        <div class="hrp-actions sticky-actions">
          ...
          <a class="hrp-btn" href="<?php echo e(route('roles.index')); ?>" style="margin-left:8px">Cancel</a>
        </div>
      </form>
    </div>
  </div>
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/roles/edit.blade.php ENDPATH**/ ?>