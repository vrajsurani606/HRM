<?php $__env->startSection('page_title', 'Edit Quotation'); ?>
...
<div class="hrp-card">
  <div class="Rectangle-30 hrp-compact">
    <form id="quotationForm" method="POST" action="<?php echo e(route('quotations.update', $quotation->id)); ?>"
      ...
      <div>
        ...
        <div class="Rectangle-29" style="display: flex; align-items: center; background: #f3f4f6;">
          <?php echo e($quotation->unique_code); ?>

        </div>
      </div>
      <div>
        <label class="hrp-label">Quotation Title: <span class="text-red-500">*</span></label>
        <input class="Rectangle-29 <?php $__errorArgs = ['quotation_title'];
...
unset($__errorArgs, $__bag); ?>" name="quotation_title" placeholder="Enter your Title" value="<?php echo e(old('quotation_title', $quotation->quotation_title)); ?>" required>
        <?php $__errorArgs = ['quotation_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
      ...
      <div>
        ...
        <input type="text" class="Rectangle-29 date-picker <?php $__errorArgs = ['quotation_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="quotation_date" placeholder="dd/mm/yyyy" value="<?php echo e(old('quotation_date', $quotation->quotation_date ? $quotation->quotation_date->format('d/m/Y') : '')); ?>" autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div class="md:col-span-1">
          ...
          <select class="Rectangle-29-select <?php $__errorArgs = ['customer_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="customer_type" id="customer_type" required>
            <option value="new" <?php echo e(old('customer_type', $quotation->customer_type) == 'new' ? 'selected' : ''); ?>>New Customer</option>
            <option value="existing" <?php echo e(old('customer_type', $quotation->customer_type) == 'existing' ? 'selected' : ''); ?>>Existing Customer</option>
          </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="lg:col-span-1 <?php echo e($quotation->customer_type == 'existing' ? '' : 'hidden'); ?>" id="existing_customer_field">
          <label class="hrp-label">Select Customer: <span class="text-red-500">*</span></label>
          <select class="Rectangle-29-select <?php $__errorArgs = ['customer_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="customer_id" id="customer_id">
            <option value="">Select Customer</option>
            <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($company->id); ?>" <?php echo e(old('customer_id', $quotation->customer_id) == $company->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div>
          ...
          <input class="Rectangle-29 <?php $__errorArgs = ['gst_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <input class="Rectangle-29 <?php $__errorArgs = ['pan_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div>
          ...
          <input class="Rectangle-29 <?php $__errorArgs = ['company_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <select name="company_type" class="Rectangle-29-select">
            ...
            <option value="INFORMATION_TECHNOLOGY" <?php echo e(old('company_type', $quotation->company_type) == 'INFORMATION_TECHNOLOGY' ? 'selected' : ''); ?>>Information Technology (IT)</option>
            <option value="SOFTWARE_DEVELOPMENT" <?php echo e(old('company_type', $quotation->company_type) == 'SOFTWARE_DEVELOPMENT' ? 'selected' : ''); ?>>Software Development</option>
            <option value="HARDWARE_ELECTRONICS" <?php echo e(old('company_type', $quotation->company_type) == 'HARDWARE_ELECTRONICS' ? 'selected' : ''); ?>>Hardware & Electronics</option>
            <option value="TELECOMMUNICATIONS" <?php echo e(old('company_type', $quotation->company_type) == 'TELECOMMUNICATIONS' ? 'selected' : ''); ?>>Telecommunications</option>
            <option value="E_COMMERCE" <?php echo e(old('company_type', $quotation->company_type) == 'E_COMMERCE' ? 'selected' : ''); ?>>E-Commerce</option>
            <option value="MANUFACTURING" <?php echo e(old('company_type', $quotation->company_type) == 'MANUFACTURING' ? 'selected' : ''); ?>>Manufacturing</option>
            <option value="AUTOMOBILE" <?php echo e(old('company_type', $quotation->company_type) == 'AUTOMOBILE' ? 'selected' : ''); ?>>Automobile</option>
            <option value="AEROSPACE_DEFENSE" <?php echo e(old('company_type', $quotation->company_type) == 'AEROSPACE_DEFENSE' ? 'selected' : ''); ?>>Aerospace & Defense</option>
            <option value="CONSTRUCTION_INFRASTRUCTURE" <?php echo e(old('company_type', $quotation->company_type) == 'CONSTRUCTION_INFRASTRUCTURE' ? 'selected' : ''); ?>>Construction & Infrastructure</option>
            <option value="REAL_ESTATE" <?php echo e(old('company_type', $quotation->company_type) == 'REAL_ESTATE' ? 'selected' : ''); ?>>Real Estate</option>
            <option value="BANKING_FINANCIAL" <?php echo e(old('company_type', $quotation->company_type) == 'BANKING_FINANCIAL' ? 'selected' : ''); ?>>Banking & Financial Services</option>
            <option value="INSURANCE" <?php echo e(old('company_type', $quotation->company_type) == 'INSURANCE' ? 'selected' : ''); ?>>Insurance</option>
            <option value="INVESTMENT_ASSET" <?php echo e(old('company_type', $quotation->company_type) == 'INVESTMENT_ASSET' ? 'selected' : ''); ?>>Investment & Asset Management</option>
            <option value="HEALTHCARE" <?php echo e(old('company_type', $quotation->company_type) == 'HEALTHCARE' ? 'selected' : ''); ?>>Healthcare</option>
            <option value="PHARMACEUTICALS" <?php echo e(old('company_type', $quotation->company_type) == 'PHARMACEUTICALS' ? 'selected' : ''); ?>>Pharmaceuticals</option>
            <option value="BIOTECHNOLOGY" <?php echo e(old('company_type', $quotation->company_type) == 'BIOTECHNOLOGY' ? 'selected' : ''); ?>>Biotechnology</option>
            <option value="MEDICAL_DEVICES" <?php echo e(old('company_type', $quotation->company_type) == 'MEDICAL_DEVICES' ? 'selected' : ''); ?>>Medical Devices</option>
            <option value="EDUCATION_TRAINING" <?php echo e(old('company_type', $quotation->company_type) == 'EDUCATION_TRAINING' ? 'selected' : ''); ?>>Education & Training</option>
            <option value="RETAIL" <?php echo e(old('company_type', $quotation->company_type) == 'RETAIL' ? 'selected' : ''); ?>>Retail</option>
            <option value="WHOLESALE_DISTRIBUTION" <?php echo e(old('company_type', $quotation->company_type) == 'WHOLESALE_DISTRIBUTION' ? 'selected' : ''); ?>>Wholesale & Distribution</option>
            <option value="LOGISTICS_SUPPLY" <?php echo e(old('company_type', $quotation->company_type) == 'LOGISTICS_SUPPLY' ? 'selected' : ''); ?>>Logistics & Supply Chain</option>
            <option value="TRANSPORTATION" <?php echo e(old('company_type', $quotation->company_type) == 'TRANSPORTATION' ? 'selected' : ''); ?>>Transportation (Air, Road, Rail, Sea)</option>
            <option value="FOOD_BEVERAGE" <?php echo e(old('company_type', $quotation->company_type) == 'FOOD_BEVERAGE' ? 'selected' : ''); ?>>Food & Beverages</option>
            <option value="HOSPITALITY" <?php echo e(old('company_type', $quotation->company_type) == 'HOSPITALITY' ? 'selected' : ''); ?>>Hospitality</option>
            <option value="TOURISM_TRAVEL" <?php echo e(old('company_type', $quotation->company_type) == 'TOURISM_TRAVEL' ? 'selected' : ''); ?>>Tourism & Travel</option>
            <option value="MEDIA_ENTERTAINMENT" <?php echo e(old('company_type', $quotation->company_type) == 'MEDIA_ENTERTAINMENT' ? 'selected' : ''); ?>>Media & Entertainment</option>
            <option value="ADVERTISING_MARKETING" <?php echo e(old('company_type', $quotation->company_type) == 'ADVERTISING_MARKETING' ? 'selected' : ''); ?>>Advertising & Marketing</option>
            <option value="PUBLISHING" <?php echo e(old('company_type', $quotation->company_type) == 'PUBLISHING' ? 'selected' : ''); ?>>Publishing</option>
            <option value="OIL_GAS" <?php echo e(old('company_type', $quotation->company_type) == 'OIL_GAS' ? 'selected' : ''); ?>>Oil & Gas</option>
            <option value="MINING_METALS" <?php echo e(old('company_type', $quotation->company_type) == 'MINING_METALS' ? 'selected' : ''); ?>>Mining & Metals</option>
            <option value="CHEMICALS" <?php echo e(old('company_type', $quotation->company_type) == 'CHEMICALS' ? 'selected' : ''); ?>>Chemicals</option>
            <option value="ENERGY_POWER" <?php echo e(old('company_type', $quotation->company_type) == 'ENERGY_POWER' ? 'selected' : ''); ?>>Energy & Power</option>
            <option value="RENEWABLE_ENERGY" <?php echo e(old('company_type', $quotation->company_type) == 'RENEWABLE_ENERGY' ? 'selected' : ''); ?>>Renewable Energy (Solar, Wind)</option>
            <option value="AGRICULTURE" <?php echo e(old('company_type', $quotation->company_type) == 'AGRICULTURE' ? 'selected' : ''); ?>>Agriculture</option>
            <option value="ENVIRONMENTAL_SERVICES" <?php echo e(old('company_type', $quotation->company_type) == 'ENVIRONMENTAL_SERVICES' ? 'selected' : ''); ?>>Environmental Services</option>
            <option value="LEGAL_SERVICES" <?php echo e(old('company_type', $quotation->company_type) == 'LEGAL_SERVICES' ? 'selected' : ''); ?>>Legal Services</option>
            <option value="CONSULTING_ADVISORY" <?php echo e(old('company_type', $quotation->company_type) == 'CONSULTING_ADVISORY' ? 'selected' : ''); ?>>Consulting & Advisory</option>
            <option value="HUMAN_RESOURCES" <?php echo e(old('company_type', $quotation->company_type) == 'HUMAN_RESOURCES' ? 'selected' : ''); ?>>Human Resources Services</option>
            <option value="BPO_KPO" <?php echo e(old('company_type', $quotation->company_type) == 'BPO_KPO' ? 'selected' : ''); ?>>BPO / KPO</option>
            <option value="SECURITY_SERVICES" <?php echo e(old('company_type', $quotation->company_type) == 'SECURITY_SERVICES' ? 'selected' : ''); ?>>Security Services</option>
            <option value="FASHION_APPAREL" <?php echo e(old('company_type', $quotation->company_type) == 'FASHION_APPAREL' ? 'selected' : ''); ?>>Fashion & Apparel</option>
            <option value="TEXTILES" <?php echo e(old('company_type', $quotation->company_type) == 'TEXTILES' ? 'selected' : ''); ?>>Textiles</option>
            <option value="SPORTS_FITNESS" <?php echo e(old('company_type', $quotation->company_type) == 'SPORTS_FITNESS' ? 'selected' : ''); ?>>Sports & Fitness</option>
            <option value="NON_PROFIT_NGO" <?php echo e(old('company_type', $quotation->company_type) == 'NON_PROFIT_NGO' ? 'selected' : ''); ?>>Non-Profit / NGO</option>
            <option value="GOVERNMENT_PUBLIC" <?php echo e(old('company_type', $quotation->company_type) == 'GOVERNMENT_PUBLIC' ? 'selected' : ''); ?>>Government & Public Sector</option>
            <option value="OTHER" <?php echo e(old('company_type', $quotation->company_type) == 'OTHER' ? 'selected' : ''); ?>>Other</option>
          </select>
        </div>
      </div>
...
unset($__errorArgs, $__bag); ?>" name="nature_of_work" placeholder="Enter Nature" value="<?php echo e(old('nature_of_work', $quotation->nature_of_work)); ?>">
          <?php $__errorArgs = ['nature_of_work'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><small class="hrp-error"><?php echo e($message); ?></small><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <select class="Rectangle-29-select <?php $__errorArgs = ['state'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="state" id="state_select">
            ...
            <option value="other" <?php echo e(old('state', $quotation->state) == 'other' ? 'selected' : ''); ?>>Other</option>
          </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <select class="Rectangle-29-select <?php $__errorArgs = ['city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div>
          ...
          <textarea class="Rectangle-29 Rectangle-29-textarea <?php $__errorArgs = ['scope_of_work'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="scope_of_work" placeholder="Enter Scope" style="min-height:80px"><?php echo e(old('scope_of_work', $quotation->scope_of_work)); ?></textarea>
          <?php $__errorArgs = ['scope_of_work'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><small class="hrp-error"><?php echo e($message); ?></small><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div>
          ...
          <input class="Rectangle-29 <?php $__errorArgs = ['contact_person_1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="contact_person_1" placeholder="Enter Contact Person Name" value="<?php echo e(old('contact_person_1', $quotation->contact_person_1)); ?>" required>
          <?php $__errorArgs = ['contact_person_1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.phone-input','data' => ['name' => 'contact_number_1','label' => 'Contact Number 1','value' => old('contact_number_1', $quotation->contact_number_1),'required' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'contact_number_1','label' => 'Contact Number 1','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('contact_number_1', $quotation->contact_number_1)),'required' => 'true']); ?>
...
<?php endif; ?>
      ...
      <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div>
          ...
          <input class="Rectangle-29 <?php $__errorArgs = ['position_1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="position_1" placeholder="Enter Position" value="<?php echo e(old('position_1', $quotation->position_1)); ?>">
          <?php $__errorArgs = ['position_1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><small class="hrp-error"><?php echo e($message); ?></small><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <?php if($quotation->contract_copy): ?>
          <div style="margin-bottom: 10px;">
            <a href="<?php echo e(route('quotations.contract.file', $quotation->id)); ?>" target="_blank" 
               style="color: #3b82f6; text-decoration: underline; font-size: 14px;">
              📄 <?php echo e(basename($quotation->contract_copy)); ?>
          ...
          <div class="upload-pill Rectangle-29 <?php $__errorArgs = ['contract_copy'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
            <div class="choose"><?php echo e($quotation->contract_copy ? 'Change File' : 'Choose File'); ?></div>
            <div class="filename" id="contractCopyName"><?php echo e($quotation->contract_copy ? 'Upload new file to replace' : 'No File Chosen'); ?></div>
            <input id="contractCopyInput" name="contract_copy" type="file" accept=".pdf,.doc,.docx,.png,.jpg,.jpeg">
          </div>
          <?php $__errorArgs = ['contract_copy'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><small class="hrp-error"><?php echo e($message); ?></small><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
      ...
      <div>
        ...
        <textarea class="Rectangle-29 Rectangle-29-textarea <?php $__errorArgs = ['contract_details'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="contract_details" placeholder="Enter Your Details" style="height:58px;resize:none;"><?php echo e(old('contract_details', $quotation->contract_details)); ?></textarea>
      ...
      <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div>
          ...
          <div style="position: relative;">
            <input class="Rectangle-29 <?php $__errorArgs = ['company_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="email" name="company_email" id="company_email" value="<?php echo e(old('company_email', $quotation->company_email)); ?>" placeholder="Add Mail-Id" required style="padding-right: 100px;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <div style="position: relative;">
            <input class="Rectangle-29 <?php $__errorArgs = ['company_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" name="company_password" id="company_password" placeholder="Enter Company Password" value="<?php echo e(old('company_password', $quotation->company_password)); ?>" required style="padding-right: 100px;">
...
<div style="margin: 30px 0;">
  ...
  <div id="premiumSection" class="Rectangle-30 hrp-compact" style="display: none;">
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; margin-bottom: 30px;">
      ...
      <label style="display: flex; align-items: center; cursor: pointer;" class="custom-checkbox">
        <input type="checkbox" name="features[]" value="<?php echo e($key); ?>" style="display: none;" 
               <?php echo e($isChecked ? 'checked' : ''); ?>>
        <div class="checkbox-box" style="width: 16px; height: 16px; border: 2px solid #000; background: <?php echo e($isChecked ? '#000' : 'white'); ?>; margin-right: 8px; display: flex; align-items: center; justify-content: center;">
          <span class="checkmark" style="color: white; font-size: 12px; font-weight: bold; display: <?php echo e($isChecked ? 'block' : 'none'); ?>;">✓</span>
        </div>
    ...
    <div style="margin-bottom: 20px;">
      ...
      <table id="basicCostTable" style="width: 100%;">
        ...
        <tbody>
          <?php if($quotation->basic_cost_description && count($quotation->basic_cost_description) > 0): ?>
            <?php $__currentLoopData = $quotation->basic_cost_description; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $description): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29" name="basic_cost[description][]" value="<?php echo e($description); ?>" style="border: none; background: transparent;"></td>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 basic-quantity" type="number" name="basic_cost[quantity][]" value="<?php echo e($quotation->basic_cost_quantity[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateBasicTotal(this)"></td>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 basic-rate" type="number" name="basic_cost[rate][]" value="<?php echo e($quotation->basic_cost_rate[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateBasicTotal(this)"></td>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 basic-total" type="number" name="basic_cost[total][]" value="<?php echo e($quotation->basic_cost_total[$index] ?? ''); ?>" style="border: none; background: transparent;" readonly></td>
      ...
      <div id="basicCostTotal" style="font-weight: 600; text-align: right; margin-top: 10px;">Total: ₹<?php echo e(number_format($quotation->basic_cost_total_amount ?? 0, 2)); ?></div>
    </div>
    ...
    <div style="margin-bottom: 20px;">
      ...
      <table id="additionalCostTable" style="width: 100%;">
        ...
        <tbody>
          <?php if($quotation->additional_cost_description && count($quotation->additional_cost_description) > 0): ?>
            <?php $__currentLoopData = $quotation->additional_cost_description; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $description): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29" name="additional_cost[description][]" value="<?php echo e($description); ?>" style="border: none; background: transparent;"></td>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 additional-quantity" type="number" name="additional_cost[quantity][]" value="<?php echo e($quotation->additional_cost_quantity[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateAdditionalTotal(this)"></td>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 additional-rate" type="number" name="additional_cost[rate][]" value="<?php echo e($quotation->additional_cost_rate[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateAdditionalTotal(this)"></td>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 additional-total" type="number" name="additional_cost[total][]" value="<?php echo e($quotation->additional_cost_total[$index] ?? ''); ?>" style="border: none; background: transparent;" readonly></td>
      ...
      <div id="additionalCostTotal" style="font-weight: 600; text-align: right; margin-top: 10px;">Total: ₹<?php echo e(number_format($quotation->additional_cost_total_amount ?? 0, 2)); ?></div>
    </div>
    ...
    <div>
      ...
      <table id="maintenanceCostTable" style="width: 100%;">
        ...
        <tbody>
          <?php if($quotation->support_description && count($quotation->support_description) > 0): ?>
            <?php $__currentLoopData = $quotation->support_description; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $description): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29" name="maintenance_cost[description][]" value="<?php echo e($description); ?>" style="border: none; background: transparent;"></td>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 maintenance-quantity" type="number" name="maintenance_cost[quantity][]" value="<?php echo e($quotation->support_quantity[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateMaintenanceTotal(this)"></td>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 maintenance-rate" type="number" name="maintenance_cost[rate][]" value="<?php echo e($quotation->support_rate[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateMaintenanceTotal(this)"></td>
              <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 maintenance-total" type="number" name="maintenance_cost[total][]" value="<?php echo e($quotation->support_total[$index] ?? ''); ?>" style="border: none; background: transparent;" readonly></td>
      ...
      <div id="maintenanceCostTotal" style="font-weight: 600; text-align: right; margin-top: 10px;">Total: ₹<?php echo e(number_format($quotation->support_total_amount ?? 0, 2)); ?></div>
    </div>
  </div>
  ...
  <div class="Rectangle-30 hrp-compact">
    <table class="services-table-1" style="width: 100%;">
      ...
      <tbody>
        <?php if($quotation->service_description && count($quotation->service_description) > 0): ?>
          <?php $__currentLoopData = $quotation->service_description; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $description): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29" name="services_1[description][]" value="<?php echo e($description); ?>" style="border: none; background: transparent;"></td>
            <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 quantity" type="number" name="services_1[quantity][]" value="<?php echo e($quotation->service_quantity[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateRowTotal(this)"></td>
            <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 rate" type="number" name="services_1[rate][]" value="<?php echo e($quotation->service_rate[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateRowTotal(this)"></td>
            <td style="padding: 12px; border-bottom: 1px solid #eee;"><input class="Rectangle-29 total" type="number" name="services_1[total][]" value="<?php echo e($quotation->service_total[$index] ?? ''); ?>" style="border: none; background: transparent;" readonly></td>
    ...
    <div style="margin-top: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px;">
      <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <input id="contract_amount" class="Rectangle-29" type="number" name="contract_amount" placeholder="Total Rate" style="width: 200px;" readonly value="<?php echo e(old('contract_amount', $quotation->service_contract_amount)); ?>">
      </div>
    </div>
  </div>
</div>
  ...
  <div class="Rectangle-30 hrp-compact">
          ...
          <tr>
            <td style="padding: 12px; border-bottom: 1px solid #eee;">
              <select class="Rectangle-29-select" name="services_2[description][]" style="border: none; background: transparent;">
                ...
                <option value="ADVANCE" <?php echo e($description == 'ADVANCE' ? 'selected' : ''); ?>>ADVANCE</option>
                <option value="ON INSTALLATION" <?php echo e($description == 'ON INSTALLATION' ? 'selected' : ''); ?>>ON INSTALLATION</option>
                <option value="COMPLETION" <?php echo e($description == 'COMPLETION' ? 'selected' : ''); ?>>COMPLETION</option>
                <option value="RETENTION" <?php echo e($description == 'RETENTION' ? 'selected' : ''); ?>>RETENTION</option>
              </select>
            </td>
            <td style="padding: 12px; border-bottom: 1px solid #eee;">
              <input class="Rectangle-29 quantity" type="number" name="services_2[quantity][]" value="<?php echo e($quotation->terms_quantity[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateRowTotal(this)">
            </td>
            <td style="padding: 12px; border-bottom: 1px solid #eee;">
              <input class="Rectangle-29 rate" type="number" name="services_2[rate][]" value="<?php echo e($quotation->terms_rate[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculateRowTotal(this)">
            </td>
            <td style="padding: 12px; border-bottom: 1px solid #eee;">
              <input class="Rectangle-29 total" type="number" name="services_2[total][]" value="<?php echo e($quotation->terms_total[$index] ?? ''); ?>" style="border: none; background: transparent;" readonly>
            </td>
            <td style="padding: 12px; border-bottom: 1px solid #eee;">
              <input class="Rectangle-29 completion-percent" type="number" min="0" max="100" name="services_2[completion_percent][]" value="<?php echo e($quotation->terms_completion[$index] ?? ''); ?>" style="border: none; background: transparent;" oninput="calculatePercentageAmount(this)">
            </td>
            <td style="padding: 12px; border-bottom: 1px solid #eee;">
              <input class="Rectangle-29" name="services_2[completion_terms][]" value="<?php echo e($quotation->completion_terms[$index] ?? ''); ?>" placeholder="Enter Terms" style="border: none; background: transparent; width: 100%;">
            </td>
            <td style="padding: 12px; border-bottom: 1px solid #eee;">
    ...
    <div class="hrp-form grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5" style="margin-top: 20px;">
      <div>
        ...
        <input type="text" class="Rectangle-29" id="services_total_amount" name="services_total_amount" placeholder="Auto-calculated" readonly value="<?php echo e(old('services_total_amount')); ?>" style="background-color: #f3f4f6; font-weight: 600;">
      </div>
      <div></div>
    </div>
  </div>
...
<div class="Rectangle-30 hrp-compact">
  <div class="hrp-form grid grid-cols-1 md:grid-cols-5 gap-4 md:gap-5" style="margin: 30px 0;">
    <div>
      ...
      <input type="text" class="Rectangle-29 date-picker" name="amc_start_date" placeholder="dd/mm/yyyy" value="<?php echo e(old('amc_start_date', $quotation->amc_start_date ? $quotation->amc_start_date->format('d/m/Y') : '')); ?>" autocomplete="off">
    </div>
    <div>
      <label class="hrp-label">AMC Amount:</label>
      <input class="Rectangle-29" name="amc_amount" placeholder="Enter Amount" value="<?php echo e(old('amc_amount', $quotation->amc_amount)); ?>">
    </div>
    <div>
      <label class="hrp-label">Project Start Date:</label>
      <input type="text" class="Rectangle-29 date-picker" name="project_start_date" placeholder="dd/mm/yyyy" value="<?php echo e(old('project_start_date', $quotation->project_start_date ? $quotation->project_start_date->format('d/m/Y') : '')); ?>" autocomplete="off">
    </div>
    <div>
      <label class="hrp-label">Completion Time:</label>
      <input class="Rectangle-29" name="completion_time" placeholder="Enter Time" value="<?php echo e(old('completion_time', $quotation->completion_time)); ?>">
    </div>
    <div>
      <label class="hrp-label">Retention Time:</label>
      <input class="Rectangle-29" name="retention_time" placeholder="Enter Time" value="<?php echo e(old('retention_time', $quotation->retention_time)); ?>">
    </div>

    <div>
      <label class="hrp-label">Retention Amount:</label>
      <input id="retention_amount" class="Rectangle-29" name="retention_amount" placeholder="Enter Amount" readonly value="<?php echo e(old('retention_amount', $quotation->retention_amount)); ?>">
    </div>
    <div>
      <label class="hrp-label">Retention %:</label>
      <input class="Rectangle-29" id="retention_percent" name="retention_percent" type="number" min="0" max="100" step="0.1" placeholder="Enter %" oninput="calculateRetentionAmount()" value="<?php echo e(old('retention_percent', $quotation->retention_percent)); ?>">
    </div>
    <div>
      <label class="hrp-label">Tentative Complete Date:</label>
      <input type="text" class="Rectangle-29 date-picker" name="tentative_complete_date" placeholder="dd/mm/yyyy" value="<?php echo e(old('tentative_complete_date', $quotation->tentative_complete_date ? $quotation->tentative_complete_date->format('d/m/Y') : '')); ?>" autocomplete="off">
    </div>
    <div></div>
    <div></div>
  </div>
  ...
  <div class="hrp-form grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5" style="margin: 30px 0;">
    <div>
      ...
      <div style="margin-bottom: 15px;">
        <textarea name="custom_terms_text" id="custom_terms_text" class="Rectangle-29" rows="4" placeholder="Enter custom terms and conditions (one per line)" style="width: 100%; resize: vertical;"><?php echo e(old('custom_terms_text', isset($quotation) && is_array($quotation->custom_terms_and_conditions) ? implode("\n", $quotation->custom_terms_and_conditions) : '')); ?></textarea>
        <small class="text-gray-500">Enter each term on a new line</small>
      </div>
    </div>
    <div>
      <label class="hrp-label">Prepared By:</label>
      <input class="Rectangle-29" name="prepared_by" placeholder="Enter Name" value="<?php echo e(old('prepared_by', $quotation->prepared_by)); ?>">
    </div>
    <div>
      <?php if (isset($component)) { $__componentOriginal7f129feca299ac4c0aa6a1d3bbb99a8a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7f129feca299ac4c0aa6a1d3bbb99a8a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.phone-input','data' => ['name' => 'mobile_no','label' => 'Mobile No.','value' => old('mobile_no', $quotation->mobile_no)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('phone-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'mobile_no','label' => 'Mobile No.','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('mobile_no', $quotation->mobile_no))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal7f129feca299ac4c0aa6a1d3bbb99a8a)): ?>
<?php $attributes = $__attributesOriginal7f129feca299ac4c0aa6a1d3bbb99a8a; ?>
...
<?php endif; ?>
    ...
    <div>
      ...
      <input class="Rectangle-29" name="footer_company_name" value="<?php echo e(old('footer_company_name', $quotation->own_company_name ?? 'CHITRI INFOTECH PVT LTD')); ?>">
    </div>
  </div>
</div>
...
<input type="hidden" name="basic_subtotal" id="hidden_basic_subtotal" value="<?php echo e(old('basic_subtotal', $quotation->basic_cost_total_amount ?? 0)); ?>">
<input type="hidden" name="additional_subtotal" id="hidden_additional_subtotal" value="<?php echo e(old('additional_subtotal', $quotation->additional_cost_total_amount ?? 0)); ?>">
<input type="hidden" name="maintenance_subtotal" id="hidden_maintenance_subtotal" value="<?php echo e(old('maintenance_subtotal', $quotation->support_total_amount ?? 0)); ?>">
    ...
    if (contractCopyInput && contractCopyName) {
        contractCopyInput.addEventListener('change', function() {
            if (this.files && this.files[0]) {
                ...
                contractCopyName.textContent = '<?php echo e($quotation->contract_copy ? "Upload new file to replace" : "No File Chosen"); ?>';
            }
        });
    }
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/quotations/edit.blade.php ENDPATH**/ ?>