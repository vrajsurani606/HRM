...
<head>
 ...
 <link rel="icon" type="image/png" href="<?php echo e(asset('logo.png')); ?>">
    ...
    <!-- Core CSS from theme -->
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/bower_components/bootstrap/dist/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/bower_components/font-awesome/css/font-awesome.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/bower_components/Ionicons/css/ionicons.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/bower_components/jquery-ui/themes/base/jquery-ui.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/dist/css/AdminLTE.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/dist/css/skins/_all-skins.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/bower_components/bootstrap-daterangepicker/daterangepicker.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/css/macos.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/css/visby-fonts.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/css/datatable.css')); ?>">
    <link rel="preload" href="<?php echo e(asset('new_theme/css/visby/VisbyRegular.otf')); ?>" as="font" type="font/otf" crossorigin>
    <link rel="preload" href="<?php echo e(asset('new_theme/css/visby/VisbyMedium.otf')); ?>" as="font" type="font/otf" crossorigin>
    <link rel="preload" href="<?php echo e(asset('new_theme/css/visby/VisbySemibold.otf')); ?>" as="font" type="font/otf" crossorigin>
    <link rel="preload" href="<?php echo e(asset('new_theme/css/visby/VisbyBold.otf')); ?>" as="font" type="font/otf" crossorigin>
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/css/jquery.dataTables.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/css/buttons.dataTables.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('new_theme/dist/css/select2.min.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('new_theme/css/hrportal.css')); ?>">
...
<div class="wrapper mac-glass-bg">
    ...
    <div class="mac-dock mac-dock-bottom">
        <?php if(auth()->user()->can('Dashboard.view dashboard') || auth()->user()->can('Dashboard.manage dashboard')): ?>
          <a class="dock-item" data-section="dashboard" href="<?php echo e(route('dashboard')); ?>" title="Dashboard"><img src="<?php echo e(asset('Doc_icon/Dashboard.png')); ?>" alt="Dashboard" /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Employees Management.view employee') || auth()->user()->can('Employees Management.manage employee') || auth()->user()->can('Leads Management.view lead') || auth()->user()->can('Leads Management.manage lead')): ?>
          <a class="dock-item" data-section="hrm" href="<?php echo e(route('hiring.index')); ?>" title="HRM"><img src="<?php echo e(asset('Doc_icon/HRM.png')); ?>" alt="HRM" /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Inquiries Management.view inquiry') || auth()->user()->can('Inquiries Management.manage inquiry')): ?>
          <a class="dock-item" data-section="inquiry-mgmt" href="<?php echo e(route('inquiries.index')); ?>" title="Inquiry Mgmt."><img src="<?php echo e(asset('Doc_icon/Inquiry Management.png')); ?>" alt="Inquiry Mgmt." /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Quotations Management.view quotation') || auth()->user()->can('Quotations Management.manage quotation')): ?>
          <a class="dock-item" data-section="quotation-mgmt" href="<?php echo e(route('quotations.index')); ?>" title="Quotation Mgmt."><img src="<?php echo e(asset('Doc_icon/Quotation Management.png')); ?>" alt="Quotation Mgmt." /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Companies Management.view company') || auth()->user()->can('Companies Management.manage company')): ?>
          <a class="dock-item" data-section="company" href="<?php echo e(route('companies.index')); ?>" title="Company"><img src="<?php echo e(asset('Doc_icon/Company Information.png')); ?>" alt="Company" /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Proformas Management.view proforma') || auth()->user()->can('Proformas Management.manage proforma') || auth()->user()->can('Invoices Management.view invoice') || auth()->user()->can('Invoices Management.manage invoice') || auth()->user()->can('Receipts Management.view receipt') || auth()->user()->can('Receipts Management.manage receipt')): ?>
          <a class="dock-item" data-section="invoice-mgmt" href="<?php echo e(route('performas.index')); ?>" title="Invoice Mgmt."><img src="<?php echo e(asset('Doc_icon/Performa Management.png')); ?>" alt="Invoice Mgmt." /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Payroll Management.view payroll') || auth()->user()->can('Payroll Management.manage payroll')): ?>
          <a class="dock-item" data-section="payroll-mgmt" href="<?php echo e(route('payroll.index')); ?>" title="Payroll Mgmt."><img src="<?php echo e(asset('Doc_icon/Payroll Management.png')); ?>" alt="Payroll Mgmt." /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Projects Management.view project') || auth()->user()->can('Projects Management.manage project')): ?>
          <a class="dock-item" data-section="project-task-mgmt" href="<?php echo e(route('projects.index')); ?>" title="Project & Task Mgmt."><img src="<?php echo e(asset('Doc_icon/Project & Task Management.png')); ?>" alt="Project & Task Mgmt." /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Tickets Management.view ticket') || auth()->user()->can('Tickets Management.manage ticket')): ?>
          <a class="dock-item" data-section="ticket" href="<?php echo e(route('tickets.index')); ?>" title="Ticket"><img src="<?php echo e(asset('Doc_icon/Ticket Support System.png')); ?>" alt="Ticket" /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Attendance Management.view attendance') || auth()->user()->can('Attendance Management.manage attendance')): ?>
          <a class="dock-item" data-section="attendance-mgmt" href="<?php echo e(route('attendance.report')); ?>" title="Attendance Mgmt."><img src="<?php echo e(asset('Doc_icon/Attendance Management.png')); ?>" alt="Attendance Mgmt." /></a>
        <?php endif; ?>
        <?php if(auth()->user()->can('Events Management.view event') || auth()->user()->can('Events Management.manage event')): ?>
          <a class="dock-item" data-section="events-mgmt" href="<?php echo e(route('events.index')); ?>" title="Events Mgmt."><img src="<?php echo e(asset('Doc_icon/Event Management..png')); ?>" alt="Events Mgmt." /></a>
        <?php endif; ?>
        <a class="dock-item" data-section="rules-regulations" href="<?php echo e(route('rules.index')); ?>" title="Rules & Regulations" target="_blank" rel="noopener"><img src="<?php echo e(asset('Doc_icon/Rules & Regulations.png')); ?>" alt="Rules & Regulations" /></a>
    </div>

</div>

<!-- Core JS from theme -->
<script src="<?php echo e(asset('new_theme/bower_components/jquery/dist/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('new_theme/bower_components/jquery-ui/jquery-ui.min.js')); ?>"></script>
<script src="<?php echo e(asset('new_theme/bower_components/bootstrap/dist/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(asset('new_theme/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')); ?>"></script>
<script src="<?php echo e(asset('new_theme/bower_components/moment/moment.js')); ?>"></script>
<script src="<?php echo e(asset('new_theme/bower_components/bootstrap-daterangepicker/daterangepicker.js')); ?>"></script>
<script src="<?php echo e(asset('new_theme/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')); ?>"></script>
<script src="<?php echo e(asset('new_theme/dist/js/select2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('new_theme/bower_components/ckeditor/ckeditor.js')); ?>"></script>
...
<script src="<?php echo e(asset('js/live-search.js')); ?>"></script>

<?php echo $__env->yieldPushContent('scripts'); ?>
<!-- Toastr initialization is handled in partials/flash.blade.php -->
</body>
</html>
<?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/layouts/macos.blade.php ENDPATH**/ ?>