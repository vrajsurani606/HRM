<?php $__env->startSection('page_title', 'Edit Receipt'); ?>
...
<form method="POST" action="<?php echo e(route('receipts.update', $receipt->id)); ?>" class="hrp-form">
  <?php echo csrf_field(); ?>
  ...
  <div class="Rectangle-30 hrp-compact">
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1.5rem; margin-bottom: 1.5rem;">
        <div>
          ...
          <input type="text" class="Rectangle-29" value="<?php echo e($receipt->unique_code); ?>" readonly style="background: #f3f4f6;">
        </div>
        <div>
          <label class="hrp-label">Rec Date: <span class="text-red-500">*</span></label>
          <input 
            type="text" 
            class="hrp-input Rectangle-29 date-picker <?php $__errorArgs = ['receipt_date'];
...
unset($__errorArgs, $__bag); ?>" 
            ...
            value="<?php echo e(old('receipt_date', $receipt->receipt_date ? $receipt->receipt_date->format('d/m/Y') : '')); ?>" 
            autocomplete="off" 
            required
          >
...
unset($__errorArgs, $__bag); ?>" name="company_name" id="companySelect" required>
            ...
            <option value="<?php echo e($company); ?>" <?php echo e(old('company_name', $receipt->company_name) == $company ? 'selected' : ''); ?>><?php echo e($company); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="invoice_type" id="invoiceTypeSelect" required>
            ...
            <option value="gst" <?php echo e(old('invoice_type', $receipt->invoice_type) == 'gst' ? 'selected' : ''); ?>>GST Invoice</option>
            <option value="without_gst" <?php echo e(old('invoice_type', $receipt->invoice_type) == 'without_gst' ? 'selected' : ''); ?>>Without GST Invoice</option>
          </select>
              ...
              <tr class="invoice-row" 
                ...
                <td style="padding: 12px;">
                  <label class="custom-checkbox" style="display: flex; align-items: center; cursor: pointer; margin: 0;">
                    <input type="checkbox" name="invoice_ids[]" value="<?php echo e($invoice->id); ?>" class="invoice-checkbox" <?php echo e(in_array($invoice->id, $selectedInvoiceIds) ? 'checked' : ''); ?> <?php echo e($balance <= 0 ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="received_amount" id="receivedAmount" value="<?php echo e(old('received_amount', $receipt->received_amount)); ?>" placeholder="0.00" readonly style="background: #FEF3C7; border: 2px solid #F59E0B; font-weight: 600; color: #92400E;" required>
...
unset($__errorArgs, $__bag); ?>" name="payment_type">
            ...
            <option value="In Account" <?php echo e(old('payment_type', $receipt->payment_type) == 'In Account' ? 'selected' : ''); ?>>In Account</option>
            <option value="Cash" <?php echo e(old('payment_type', $receipt->payment_type) == 'Cash' ? 'selected' : ''); ?>>Cash</option>
            <option value="Cheque" <?php echo e(old('payment_type', $receipt->payment_type) == 'Cheque' ? 'selected' : ''); ?>>Cheque</option>
            <option value="Online Transfer" <?php echo e(old('payment_type', $receipt->payment_type) == 'Online Transfer' ? 'selected' : ''); ?>>Online Transfer</option>
          </select>
...
unset($__errorArgs, $__bag); ?>" name="narration" value="<?php echo e(old('narration', $receipt->narration)); ?>" placeholder="Enter Narration">
...
unset($__errorArgs, $__bag); ?>" name="trans_code" value="<?php echo e(old('trans_code', $receipt->trans_code)); ?>" placeholder="Enter SAC Code">
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/receipts/edit.blade.php ENDPATH**/ ?>