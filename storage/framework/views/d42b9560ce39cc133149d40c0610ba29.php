<?php $__env->startSection('page_title','Add New Inquiry'); ?>
...
<div class="Rectangle-30 hrp-compact">
  ...
  <form id="inquiryForm" method="POST" action="<?php echo e(route('inquiries.store')); ?>" enctype="multipart/form-data" class="hrp-form grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
    <?php echo csrf_field(); ?>
    ...
    <div>
      ...
      <div class="Rectangle-29" style="display:flex;align-items:center;justify-content:space-between;background:#f3f4f6;">
        <span><?php echo e($nextCode ?? 'CMS/INQ/0001'); ?></span>
      </div>
    </div>
    <div>
      ...
      <input
        ...
        name="inquiry_date"
        value="<?php echo e(old('inquiry_date', now()->format('d/m/Y'))); ?>"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <input class="hrp-input Rectangle-29" name="company_name" value="<?php echo e(old('company_name')); ?>" placeholder="Enter your company name" />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <textarea class="hrp-textarea Rectangle-29 Rectangle-29-textarea" name="company_address" placeholder="Enter Your Address" style="height:58px;resize:none;"><?php echo e(old('company_address')); ?></textarea>
    ...
    <div>
      ...
      <select class="Rectangle-29 Rectangle-29-select" name="industry_type">
        ...
        <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($industry); ?>" <?php echo e(old('industry_type') == $industry ? 'selected' : ''); ?>><?php echo e($industry); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </select>
    </div>
    <div>
      <label class="hrp-label">Email :</label>
      <input class="hrp-input Rectangle-29" type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter Company Email" />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <input
        ...
        pattern="\d{10}"
        maxlength="10"
        value="<?php echo e(old('company_phone')); ?>"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <input
        ...
        pattern="\d{10}"
        maxlength="10"
        value="<?php echo e(old('contact_mobile')); ?>"
        placeholder="Enter 10 digit mobile number"
      />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <input class="hrp-input Rectangle-29" name="contact_name" value="<?php echo e(old('contact_name')); ?>" placeholder="Enter Contact Person Name" />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <input class="hrp-input Rectangle-29" name="scope_link" value="<?php echo e(old('scope_link')); ?>" placeholder="Enter Scope Link" />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <input class="hrp-input Rectangle-29" name="contact_position" value="<?php echo e(old('contact_position')); ?>" placeholder="Enter Contact Person Position" />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <select class="Rectangle-29-select" name="quotation_sent">
        ...
        <option value="Yes" <?php echo e(old('quotation_sent') === 'Yes' ? 'selected' : ''); ?>>Yes</option>
        <option value="No" <?php echo e(old('quotation_sent') === 'No' ? 'selected' : ''); ?>>No</option>
      </select>
    </div>
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/inquiries/create.blade.php ENDPATH**/ ?>