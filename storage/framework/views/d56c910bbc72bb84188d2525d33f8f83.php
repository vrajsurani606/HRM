<?php $__env->startSection('page_title', 'Project Stages Settings'); ?>
  ...
  <div class="hrp-card-body">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
      ...
      <div style="display: flex; gap: 12px;">
        <a href="<?php echo e(route('projects.index')); ?>" class="pill-btn pill-secondary">
    ...
    <div class="stages-list" id="stagesList">
      <?php $__empty_1 = true; $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <div class="stage-item" data-id="<?php echo e($stage->id); ?>" style="border-left-color: <?php echo e($stage->color); ?>;">
        ...
        <div class="stage-order"><?php echo e($index + 1); ?></div>
        
        <div class="stage-color-indicator" style="background: <?php echo e($stage->color); ?>;"></div>
        
        <div class="stage-info">
          <h3 class="stage-name"><?php echo e($stage->name); ?></h3>
          <div class="stage-meta">
            <span class="stage-count">
              ...
              <?php echo e($stage->projects_count); ?> <?php echo e(Str::plural('project', $stage->projects_count)); ?>

            </span>
            <span style="font-family: monospace; font-size: 12px;"><?php echo e($stage->color); ?></span>
          </div>
          <?php if($stage->description): ?>
          <p class="stage-description"><?php echo e($stage->description); ?></p>
          <?php endif; ?>
        </div>
        
        <div class="stage-actions">
          <button onclick="editStage(<?php echo e($stage->id); ?>)" class="stage-action-btn btn-edit-stage">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <button onclick="deleteStage(<?php echo e($stage->id); ?>, '<?php echo e($stage->name); ?>', <?php echo e($stage->projects_count); ?>)" class="stage-action-btn btn-delete-stage">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<a href="<?php echo e(route('projects.index')); ?>" style="font-weight:800;color:#0f0f0f;text-decoration:none">Projects</a>
<span class="hrp-bc-sep">›</span>
...
<script>
  ...
  async function updateStageOrder() {
    ...
    const updateUrl = '<?php echo e(route("project-stages.update-order")); ?>';
...
<script>
  ...
  document.getElementById('stageForm').addEventListener('submit', async function(e) {
    ...
    const url = stageId ? `<?php echo e(url('project-stages')); ?>/${stageId}` : '<?php echo e(route("project-stages.store")); ?>';
  ...
  async function editStage(id) {
    try {
      const response = await fetch(`<?php echo e(url('project-stages')); ?>/${id}`);
      const data = await response.json();
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/projects/stages/index.blade.php ENDPATH**/ ?>