<div style="background:white;border-radius:20px;box-shadow:0 2px 8px rgba(0,0,0,0.08);border:1px solid #e5e7eb;padding:30px;margin:12px 0 24px">
  <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:32px;padding-bottom:20px;border-bottom:2px solid #f3f4f6;">
    ...
    <?php if($employee && (auth()->user()->can('Profile Management.update bank details') || auth()->user()->can('Profile Management.edit own profile'))): ?>
  ...
  <div id="bankViewMode">
      ...
      <div style="background:linear-gradient(135deg,#f0f9ff 0%,#e0f2fe 100%);padding:24px;border-radius:12px;border:1px solid #bae6fd;">
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
          ...
          <div>
            ...
            <div style="font-size:18px;color:#0c4a6e;font-weight:700;"><?php echo e($employee->bank_name ?? 'Not Provided'); ?></div>
          </div>
        </div>
      </div>
          ...
          <div>
            ...
            <div style="font-size:18px;color:#065f46;font-weight:700;font-family:monospace;">
              <?php if($employee->bank_account_no): ?>
                <?php echo e(substr($employee->bank_account_no, 0, 4)); ?>••••<?php echo e(substr($employee->bank_account_no, -4)); ?>
      ...
      <div style="background:linear-gradient(135deg,#fef3c7 0%,#fde68a 100%);padding:24px;border-radius:12px;border:1px solid #fcd34d;">
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
          ...
          <div>
            ...
            <div style="font-size:18px;color:#92400e;font-weight:700;font-family:monospace;"><?php echo e($employee->bank_ifsc ?? 'Not Provided'); ?></div>
          </div>
        </div>
      </div>
      ...
      <div style="background:linear-gradient(135deg,#fae8ff 0%,#f3e8ff 100%);padding:24px;border-radius:12px;border:1px solid #e9d5ff;">
        <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
          ...
          <div>
            ...
            <div style="font-size:18px;color:#6b21a8;font-weight:700;"><?php echo e($employee->name ?? $user->name); ?></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div style="background:#f9fafb;padding:20px;border-radius:12px;border:1px solid #e5e7eb;margin-bottom:24px;">
      <div style="display:flex;align-items:center;justify-content:space-between;">
        ...
        <?php if($employee->cheque_photo): ?>
          <a href="<?php echo e(storage_asset($employee->cheque_photo)); ?>" target="_blank" 
    ...
    <!-- Account Status -->
    <div style="text-align:center;padding:32px 20px;background:<?php echo e($employee->bank_name && $employee->bank_account_no && $employee->bank_ifsc ? 'linear-gradient(135deg,#dcfce7 0%,#bbf7d0 100%)' : 'linear-gradient(135deg,#fee2e2 0%,#fecaca 100%)'); ?>;border-radius:12px;border:1px solid <?php echo e($employee->bank_name && $employee->bank_account_no && $employee->bank_ifsc ? '#86efac' : '#fca5a5'); ?>;">
      <?php if($employee->bank_name && $employee->bank_account_no && $employee->bank_ifsc): ?>
  ...
  <div id="bankEditMode" style="display:none;">
    <form method="post" action="<?php echo e(route('profile.bank.update')); ?>">
      <?php echo csrf_field(); ?>
      ...
      <div>
        ...
        <input type="text" id="bank_name" name="bank_name" 
               value="<?php echo e(old('bank_name', $employee->bank_name ?? '')); ?>" required 
        ...
        <?php if($errors->get('bank_name')): ?>
          <div style="color:#ef4444;font-size:13px;margin-top:6px;"><?php echo e($errors->first('bank_name')); ?></div>
        <?php endif; ?>
      </div>
      ...
      <div>
        ...
        <input type="text" id="bank_account_no" name="bank_account_no" 
               value="<?php echo e(old('bank_account_no', $employee->bank_account_no ?? '')); ?>" required 
               placeholder="Enter account number" maxlength="30"
               style="width:100%;padding:12px 16px;border:1px solid #d1d5db;border-radius:8px;font-size:14px;transition:all 0.2s;"
               onfocus="this.style.borderColor='#3b82f6';this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.1)'"
               onblur="this.style.borderColor='#d1d5db';this.style.boxShadow='none'" />
        <?php if($errors->get('bank_account_no')): ?>
          <div style="color:#ef4444;font-size:13px;margin-top:6px;"><?php echo e($errors->first('bank_account_no')); ?></div>
        <?php endif; ?>
      </div>
      ...
      <div>
        ...
        <input type="text" id="bank_ifsc" name="bank_ifsc" 
               value="<?php echo e(old('bank_ifsc', $employee->bank_ifsc ?? '')); ?>" required 
               ...
               onfocus="this.style.borderColor='#3b82f6';this.style.boxShadow='0 0 0 3px rgba(59,130,246,0.1)'"
               onblur="this.style.borderColor='#d1d5db';this.style.boxShadow='none'" />
        <?php if($errors->get('bank_ifsc')): ?>
          <div style="color:#ef4444;font-size:13px;margin-top:6px;"><?php echo e($errors->first('bank_ifsc')); ?></div>
        <?php endif; ?>
      ...
      <div>
        ...
        <input type="text" value="<?php echo e($employee->name ?? $user->name); ?>" readonly 
    ...
    <div style="margin-top:32px;padding:24px;background:linear-gradient(135deg,#f0f9ff 0%,#e0f2fe 100%);border:1px solid #bae6fd;border-radius:12px;">
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:16px;">
        <div style="background:white;padding:16px;border-radius:8px;border:1px solid #e0f2fe;">
          ...
          <div style="font-size:16px;color:#0f172a;font-weight:700;"><?php echo e($employee->bank_name ?? '—'); ?></div>
        </div>
        <div style="background:white;padding:16px;border-radius:8px;border:1px solid #e0f2fe;">
        ...
        <div style="background:white;padding:16px;border-radius:8px;border:1px solid #e0f2fe;">
          ...
          <div style="font-size:16px;color:#0f172a;font-weight:700;font-family:monospace;"><?php echo e($employee->bank_ifsc ?? '—'); ?></div>
        </div>
        <div style="background:white;padding:16px;border-radius:8px;border:1px solid #e0f2fe;">
      ...
      <div style="margin-top:32px;padding-top:24px;border-top:2px solid #f3f4f6;display:flex;align-items:center;gap:16px;">
        ...
        <?php if(session('status') === 'bank-updated'): ?>
...
<?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/profile/partials/bank-details.blade.php ENDPATH**/ ?>