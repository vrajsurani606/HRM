...
<link rel="stylesheet" href="<?php echo e(asset('new_theme/css/kanban.css')); ?>">
<style>
...
<div class="hrp-content">
  ...
  <div class="kanban-header">
    ...
    <div class="header-controls">
      ...
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.manage project')): ?>
        <button class="create-stage-btn" onclick="window.location.href='<?php echo e(route('project-stages.index')); ?>'" title="Manage Project Stages" style="background: #6b7280;">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <?php endif; ?>
      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.create project')): ?>
  ...
  <div class="kanban-board">
    ...
    <div class="kanban-column" style="background: <?php echo e($stage->color); ?>" data-stage-id="<?php echo e($stage->id); ?>">
      <div class="column-header">
        <div class="column-title">
          <span><?php echo e($stage->name); ?></span>
        </div>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.create project')): ?>
          <button class="add-card-btn" onclick="openProjectModal(<?php echo e($stage->id); ?>)">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <line x1="12" y1="5" x2="12" y2="19" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
              <line x1="5" y1="12" x2="19" y2="12" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            </svg>
      ...
      <div class="kanban-cards" data-stage-id="<?php echo e($stage->id); ?>">
        <?php $__currentLoopData = $stage->projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="kanban-card clickable-card" draggable="true" data-project-id="<?php echo e($project->id); ?>">
          <div class="card-header">
            ...
            <?php if($project->due_date): ?>
              ...
              ?>
              <span class="card-date <?php echo e($isCompleted ? 'completed' : ($isOverdue ? 'overdue' : ($isUrgent ? 'urgent' : ''))); ?>">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <circle cx="12" cy="12" r="10"></circle>
                  <polyline points="12 6 12 12 16 14"></polyline>
                </svg>
                <?php echo e($project->due_date->format('d M')); ?>

                <?php if($isOverdue && !$isCompleted): ?>
                  <span class="overdue-badge"><?php echo e($absDays); ?> <?php echo e($dayText); ?> overdue</span>
                <?php elseif($isUrgent && !$isCompleted): ?>
                  <span class="urgent-badge"><?php echo e($daysLeft); ?> <?php echo e($dayText); ?> left</span>
                <?php endif; ?>
              </span>
            <?php endif; ?>
          </div>
          <div class="card-meta">
            <div class="card-stats">
              ...
              <span class="task-count"><?php echo e($project->completed_tasks); ?>/<?php echo e($project->total_tasks); ?></span>
            </div>
  ...
  <div class="projects-grid-view">
    <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php $__currentLoopData = $stage->projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="project-grid-card" onclick="viewProject(<?php echo e($project->id); ?>, event)">
        <div class="project-grid-header">
          <h3 class="project-grid-title"><?php echo e($project->name); ?></h3>
          <span class="project-grid-stage" style="background: <?php echo e($stage->color); ?>; color: #000;">
        ...
        <p class="project-grid-description"><?php echo e($project->description); ?></p>
        <?php endif; ?>
        
        <div class="project-grid-meta">
          <div class="project-grid-progress">
            <div class="project-grid-progress-text">
              <?php echo e($project->completed_tasks); ?>/<?php echo e($project->total_tasks); ?> Tasks
            </div>
            <div class="project-grid-progress-bar">
              <div class="project-grid-progress-fill" style="width: <?php echo e($project->progress); ?>%"></div>
            </div>
          </div>
          
          <div class="project-grid-actions" onclick="event.stopPropagation()">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.view project')): ?>
              <button class="project-grid-action-btn btn-view" onclick="viewProject(<?php echo e($project->id); ?>, event)" title="View Project">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.edit project')): ?>
              <button class="project-grid-action-btn btn-edit" onclick="editProject(<?php echo e($project->id); ?>)" title="Edit Project">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.view project')): ?>
              <button class="project-grid-action-btn btn-overview" onclick="window.location.href='<?php echo e(url('/projects')); ?>/<?php echo e($project->id); ?>/overview'" title="Project Overview">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.delete project')): ?>
              <button class="project-grid-action-btn btn-delete" onclick="deleteProject(<?php echo e($project->id); ?>)" title="Delete Project">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <table>
        ...
        <tbody>
          <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
              <td>
                <span class="project-list-name" onclick="viewProject(<?php echo e($project->id); ?>, event)">
                  <?php echo e($project->name); ?>

                </span>
              </td>
              <td><?php echo e($project->company->company_name ?? 'N/A'); ?></td>
              <td>
                <span class="project-list-stage-badge" style="background: <?php echo e($stage->color); ?>; color: #000;">
                  <?php echo e($stage->name); ?>
              ...
              <td>
                <div class="project-list-progress">
                  <div class="project-list-progress-bar">
                    <div class="project-list-progress-fill" style="width: <?php echo e($project->progress); ?>%"></div>
                  </div>
                  <span class="project-list-progress-text"><?php echo e($project->progress); ?>%</span>
                </div>
              </td>
              <td><?php echo e($project->due_date ? $project->due_date->format('M d, Y') : 'N/A'); ?></td>
              <td>
                <span style="color: <?php echo e($project->priority === 'high' ? '#ef4444' : ($project->priority === 'medium' ? '#f59e0b' : '#10b981')); ?>; font-weight: 500; text-transform: capitalize;">
                  <?php echo e($project->priority ?? 'medium'); ?>
              ...
              <td>
                <div class="project-list-actions">
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.view project')): ?>
                    <button class="project-list-action-btn btn-view" onclick="viewProject(<?php echo e($project->id); ?>, event)" title="View Project">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                        <circle cx="12" cy="12" r="3"></circle>
                      </svg>
                  ...
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.edit project')): ?>
                    <button class="project-list-action-btn btn-edit" onclick="editProject(<?php echo e($project->id); ?>)" title="Edit Project">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                      </svg>
                  ...
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.view project')): ?>
                    <button class="project-list-action-btn btn-overview" onclick="window.location.href='<?php echo e(url('/projects')); ?>/<?php echo e($project->id); ?>/overview'" title="Project Overview">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <rect x="3" y="3" width="7" height="7"></rect>
                        <rect x="14" y="3" width="7" height="7"></rect>
                        <rect x="14" y="14" width="7" height="7"></rect>
                  ...
                  <?php endif; ?>
                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Projects Management.delete project')): ?>
                    <button class="project-list-action-btn btn-delete" onclick="deleteProject(<?php echo e($project->id); ?>)" title="Delete Project">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polyline points="3 6 5 6 21 6"></polyline>
                        <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                      </svg>
...
function updateProjectStage(projectId, stageId) {
    ...
    fetch('<?php echo e(url("/projects")); ?>/' + projectId + '/stage', {
        method: 'PATCH',
        headers: {
...
document.getElementById('stageForm').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route("project-stages.store")); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
        },
...
function viewProject(projectId, event) {
    ...
    const url = '<?php echo e(url("/projects")); ?>/' + projectId;
    ...
    .then(data => {
        ...
        <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            companyOptions += '<option value="<?php echo e($comp->id); ?>" ' + (project.company_id == <?php echo e($comp->id); ?> ? 'selected' : '') + '><?php echo e($comp->company_name); ?></option>';
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
function saveProjectDescription(projectId, description) {
    fetch('<?php echo e(url("/projects")); ?>/' + projectId, {
        method: 'PATCH',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
function saveNewTask() {
    ...
    fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/tasks`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
async function toggleTaskComplete(taskId) {
        ...
        for (const subtaskCheckbox of subtaskCheckboxes) {
            if (!subtaskCheckbox.checked) {
                ...
                if (subtaskElement) {
                    ...
                    await fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/tasks/${subtaskDbId}`, {
                        method: 'PUT',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
    ...
    try {
        const response = await fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/tasks/${taskDbId}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
function saveSubtaskDate(subtaskId) {
    ...
    if (dateInput.value) {
        ...
        // Save to database
        fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/tasks/${subtaskDbId}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
async function toggleSubtaskComplete(subtaskId, taskId) {
    ...
    try {
        const response = await fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/tasks/${subtaskDbId}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
        ...
        if (data.success) {
            ...
            if (allCompleted && allSubtaskCheckboxes.length > 0) {
                ...
                if (mainTaskCheckbox && !mainTaskCheckbox.checked) {
                    ...
                    // Save main task to database
                    const taskDbId = taskId.split('-')[1];
                    await fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/tasks/${taskDbId}`, {
                        method: 'PUT',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
function deleteTask(taskId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/tasks/${taskDbId}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                    'Accept': 'application/json'
...
function loadProjectTasks(projectId) {
    ...
    fetch(`<?php echo e(url('/projects')); ?>/${projectId}/tasks`, {
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
            'Accept': 'application/json'
        }
...
function loadComments(projectId) {
    fetch(`<?php echo e(url('/projects')); ?>/${projectId}/comments`, {
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
            'Accept': 'application/json'
        }
...
function sendChatMessage() {
    ...
    const url = `<?php echo e(url('/projects')); ?>/${currentProjectId}/comments`;
    console.log('URL:', url);
...
async function updateCurrentProjectDueDate(dueDate) {
    ...
    try {
        const response = await fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
function openAddMemberModal() {
    ...
    fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/available-users`, {
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
            'Accept': 'application/json'
        }
...
function renderMemberCards(users) {
    ...
    users.forEach(user => {
        ...
        const photoPath = user.employee && user.employee.photo_path 
            ? `<?php echo e(asset('storage')); ?>/${user.employee.photo_path}`
            : null;
...
function addSelectedMembers() {
    ...
    const promises = selectedMembers.map(user => {
        return fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/members`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
function removeMember(userId, avatarElement) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch(`<?php echo e(url('/projects')); ?>/${currentProjectId}/members/${userId}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                    'Accept': 'application/json'
...
function loadProjectMembers(projectId) {
    fetch(`<?php echo e(url('/projects')); ?>/${projectId}/members`, {
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
            'Accept': 'application/json'
        }
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/projects/index.blade.php ENDPATH**/ ?>