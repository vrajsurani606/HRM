...
<a href="<?php echo e(route('roles.index')); ?>" class="pill-btn back-btn" title="Back to Roles">
      ...
      <form action="<?php echo e(route('roles.store')); ?>" method="POST" class="grid grid-cols-1 gap-3">
        <?php echo csrf_field(); ?>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            <label class="hrp-label">Name<span style="color:#ef4444"> *</span></label>
            <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Enter Role Name" class="hrp-input Rectangle-29" required>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div>
            ...
            <textarea name="description" rows="1" placeholder="Role description" class="hrp-textarea Rectangle-29 Rectangle-29-textarea"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="perm-grid">
                      <?php $__currentLoopData = $modulePermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="custom-checkbox">
                          <input type="checkbox" class="permission-checkbox" name="permissions[]" value="<?php echo e($permission->name); ?>" id="permission_<?php echo e($permission->id); ?>" data-module="<?php echo e($module); ?>" <?php echo e(in_array($permission->name, old('permissions', [])) ? 'checked' : ''); ?>>
                          <div class="checkbox-box"><span class="checkmark">✓</span></div>
        ...
        <div class="hrp-actions sticky-actions" style="gap:8px; justify-content:flex-end">
          ...
          <a class="hrp-btn" href="<?php echo e(route('roles.index')); ?>" style="background:#fff;color:#111827;border:1px solid #e5e7eb">Cancel</a>
        </div>
      </form>
    </div>
  </div>
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/roles/create.blade.php ENDPATH**/ ?>