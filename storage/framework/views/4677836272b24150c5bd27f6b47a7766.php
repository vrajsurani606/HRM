...
<body class="min-h-screen bg-white dark:bg-slate-900 font-[Instrument_Sans]">
  ...
  <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
    <div class="hidden lg:flex items-center justify-center p-8 bg-white dark:bg-slate-800">
      <div class="w-full h-full max-w-4xl max-h-[90vh] flex items-center justify-center">
        <lottie-player
          src="<?php echo e(asset('public/lottie/hr-animation.json')); ?>"
          ...
          <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
            ...
            <div>
              <div class="flex items-center justify-between mb-1">
                ...
                <a href="<?php echo e(route('password.request')); ?>" class="text-emerald-600 hover:underline text-sm">Forgot Password?</a>
              </div>
            ...
            <p class="text-center text-sm text-gray-600 dark:text-gray-400">Don't have an account? <a href="<?php echo e(route('register')); ?>" class="text-emerald-600 hover:underline font-medium">Sign up</a></p>
          </form>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    const localLottie = '<?php echo e(asset("lottie/hr-animation.json")); ?>';
...
<?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/auth/login.blade.php ENDPATH**/ ?>