      ...
      <div class="top-right">
        ...
        <div class="notify-pill" title="Notifications" style="position: relative;">
          <span class="notify-bell" id="notifyBellBtn" style="cursor: pointer;">
            ...
            <span class="badge-dot" id="notifyBadge"><?php echo e((isset($notifications) && is_countable($notifications)) ? count($notifications) : 0); ?></span>
          </span>
          ...
          <div id="notifyDropdown" class="notify-dropdown" style="display: none; position: absolute; top: 48px; right: 0; width: 360px; background: white; border-radius: 16px; box-shadow: 0 10px 40px rgba(0,0,0,0.15); z-index: 1000; overflow: hidden; border: 1px solid #e2e8f0;">
            ...
            <div id="notifyList" style="max-height: 350px; overflow-y: auto;">
              <?php $__empty_1 = true; $__currentLoopData = ($notifications ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e($notif['link'] ?? '#'); ?>" class="notify-item" style="display: flex; align-items: flex-start; gap: 12px; padding: 14px 20px; border-bottom: 1px solid #f1f5f9; text-decoration: none; transition: background 0.2s;" onmouseover="this.style.background='#f8fafc'" onmouseout="this.style.background='white'">
                  <span style="font-size: 24px; flex-shrink: 0;"><?php echo e($notif['icon'] ?? '📌'); ?></span>
                  <div style="flex: 1; min-width: 0;">
                    <div style="font-size: 13px; font-weight: 600; color: #1e293b; margin-bottom: 4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo e($notif['title'] ?? 'Notification'); ?></div>
                    <div style="font-size: 12px; color: #64748b; margin-bottom: 4px;"><?php echo e($notif['subtitle'] ?? ''); ?></div>
                    <div style="font-size: 11px; color: #94a3b8; display: flex; align-items: center; gap: 4px;">
                      <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                      <?php echo e($notif['time'] ?? 'Just now'); ?>
            ...
            <div style="padding: 12px 20px; background: #f8fafc; border-top: 1px solid #e2e8f0; text-align: center;">
              <a href="<?php echo e(route('tickets.index')); ?>" style="font-size: 13px; color: #3b82f6; font-weight: 600; text-decoration: none;">View All Tickets →</a>
            </div>
            <?php endif; ?>
          </div>
        </div>
      ...
      <div class="hrp-grid">
        <div class="hrp-col-3">
          <div class="dash-kpi kpi-emp">
            <div class="kpi-top">
              <div class="kpi-left">
                <div class="kpi-ico"><img src="<?php echo e(asset('kpi_icon/kpi1.svg')); ?>" alt="Employees"></div>
              </div>
              <div class="value"><?php echo e(data_get($stats, 'employees', 0)); ?></div>
            </div>
            <div class="kpi-title">Total Employees</div>
            <div class="kpi-sub <?php echo e($empDeltaClass); ?>"><?php echo e($empDelta); ?> From Last Month</div>
          </div>
        </div>
        <div class="hrp-col-3">
          <div class="dash-kpi kpi-proj">
            <div class="kpi-top">
              <div class="kpi-left">
                <div class="kpi-ico"><img src="<?php echo e(asset('kpi_icon/kpi2.svg')); ?>" alt="Projects"></div>
              </div>
              <div class="value"><?php echo e(data_get($stats, 'projects', 0)); ?></div>
            </div>
            <div class="kpi-title">Active Projects</div>
            <div class="kpi-sub <?php echo e($projDeltaClass); ?>"><?php echo e($projDelta); ?> From Last Month</div>
          </div>
        </div>
        <div class="hrp-col-3">
          <div class="dash-kpi kpi-task">
            <div class="kpi-top">
              <div class="kpi-left">
                <div class="kpi-ico"><img src="<?php echo e(asset('kpi_icon/kpi3.svg')); ?>" alt="Open Positions"></div>
              </div>
              <div class="value"><?php echo e(data_get($stats, 'open_positions', 0)); ?></div>
            </div>
            <div class="kpi-title">Pending Tasks</div>
            <div class="kpi-sub <?php echo e($urgentCount > 0 ? 'red' : 'blue'); ?>"><?php echo e($urgentCount); ?> Urgent Priority</div>
          </div>
        </div>
        <div class="hrp-col-3">
          <div class="dash-kpi kpi-attn">
            <div class="kpi-top">
              <div class="kpi-left">
                <div class="kpi-ico"><img src="<?php echo e(asset('kpi_icon/kpi4.svg')); ?>" alt="Attendance"></div>
              </div>
              <div class="value"><?php echo e(data_get($stats, 'attendance_percent', '0%')); ?></div>
            </div>
            <div class="kpi-title">Attendance Today</div>
            <div class="kpi-sub blue"><?php echo e(data_get($stats, 'attendance_present', '0/0')); ?> Present</div>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="hrp-table-wrap">
            <table class="hrp-table">
              ...
              <?php $__empty_1 = true; $__currentLoopData = ($recentInquiries ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                  <td>
                    <a href="<?php echo e(route('inquiries.show', $inq['id'] ?? 1)); ?>" class="action-icon view" title="View Inquiry" style="display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; background: #eff6ff; border-radius: 6px; border: none;">
                      <img src="<?php echo e(asset('action_icon/view.svg')); ?>" alt="view" style="width: 16px; height: 16px;">
                    </a>
                  </td>
                  <td><span class="<?php echo e($confirmClass); ?>" style="font-weight: 600;"><?php echo e($isConfirm); ?></span></td>
                  <td style="font-weight: 600; color: #1e293b;"><?php echo e($inq['company'] ?? '—'); ?></td>
                  <td style="color: #475569;"><?php echo e($inq['person'] ?? '—'); ?></td>
                  <td style="font-family: monospace; color: #64748b;"><?php echo e($inq['phone'] ?? '—'); ?></td>
                  <td style="color: #2563eb; font-weight: 500;"><?php echo e($inq['next'] ?? $inq['date'] ?? '—'); ?></td>
                  <td><span class="<?php echo e($statusClass); ?>" style="font-weight: 500;"><?php echo e($status); ?></span></td>
                  <td style="font-size: 12px; color: #64748b;"><?php echo e($inq['demo'] ?? '—'); ?></td>
                </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
        ...
        <div class="table-body">
          <div class="hrp-table-wrap">
            <table class="hrp-table">
              ...
              <tbody>
              <?php $__empty_1 = true; $__currentLoopData = ($recentTickets ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr data-ticket-id="<?php echo e($t['id'] ?? ''); ?>">
                  <td class="action-icons" style="display: flex; gap: 6px;">
                    <a href="<?php echo e(route('tickets.show', $t['id'] ?? 1)); ?>" class="action-icon view" title="View Ticket" style="display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; background: #eff6ff; border-radius: 6px; border: none;">
                      <img src="<?php echo e(asset('action_icon/view.svg')); ?>" alt="view" style="width: 16px; height: 16px;">
                    </a>
                    <form action="<?php echo e(route('tickets.destroy', $t['id'] ?? 1)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this ticket?');">
                      <?php echo csrf_field(); ?>
                      ...
                      <button type="submit" class="action-icon delete" title="Delete Ticket" style="display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; background: #fef2f2; border-radius: 6px; border: none; cursor: pointer;">
                        <img src="<?php echo e(asset('action_icon/delete.svg')); ?>" alt="delete" style="width: 16px; height: 16px;">
                      </button>
                    </form>
                  </td>
                  <td style="font-weight: 600;"><?php echo e($idx + 1); ?></td>
                  <td><span class="link-blue" style="font-weight: 500;"><?php echo e($t['status'] ?? 'Open'); ?></span></td>
                  <td class="<?php echo e(($t['priority'] ?? '') === 'green' ? 'text-green' : (($t['priority'] ?? '') === 'orange' ? 'text-orange' : '')); ?>" style="font-weight: 500;"><?php echo e($t['work'] ?? 'Not Assigned'); ?></td>
                  <td><?php echo e($t['category'] ?? 'General'); ?></td>
                  <td><?php echo e($t['customer'] ?? '—'); ?></td>
                  <td style="max-width: 150px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo e($t['title'] ?? '—'); ?></td>
                  <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo e($t['desc'] ?? '—'); ?></td>
                </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
      ...
      <div class="hrp-card card-p-0">
        ...
        <div class="hrp-card-body-note">
          <div class="tab-pane show" id="tab-notes">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Dashboard.manage dashboard')): ?>
      ...
      <div class="modal-body">
        <div class="employee-grid" id="employeeGrid">
          <?php $__currentLoopData = ($users ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="employee-card" data-id="<?php echo e($user['id']); ?>" data-name="<?php echo e($user['name']); ?>">
              <div class="employee-checkbox">
                <input type="checkbox" id="emp_<?php echo e($user['id']); ?>" value="<?php echo e($user['id']); ?>">
              </div>
              <div class="employee-avatar">
                <img src="<?php echo e($user['photo']); ?>" alt="<?php echo e($user['name']); ?>" onerror="this.src='<?php echo e(asset('new_theme/dist/img/avatar.png')); ?>'">
              </div>
              <div class="employee-name"><?php echo e($user['name']); ?></div>
            </div>
...
<script src="<?php echo e(asset('new_theme/bower_components/chart.js/Chart.js')); ?>"></script>
<script>
      ...
      if(canvas3 && window.Chart){
        requestAnimationFrame(function(){
          try{
            ...
            var companyData = <?php echo json_encode($companyData ?? [], 15, 512) ?>;
...
<script>
  ...
  function loadSystemNotes(page) {
    ...
    fetch('<?php echo e(route("employee.notes.get")); ?>?type=system&page=' + page + '&limit=' + systemNotesPerPage, {
      headers: {
  ...
  function editSystemNote(noteId) {
    ...
    if (newText && newText.trim() && newText.trim() !== currentText) {
      ...
      fetch('<?php echo e(url("/api/admin-notes")); ?>/' + noteId, {
        method: 'PUT',
        headers: {
  ...
  function editAdminNoteEmployees(noteId) {
    ...
    fetch('<?php echo e(route("employee.notes.get")); ?>?type=employee&limit=500', {
      headers: {
        'Accept': 'application/json',
        'X-Requested-With': 'XMLHttpRequest'
      }
        ...
        checkboxes.forEach(function(cb) {
          ...
          if (isSelected) {
            ...
            selectedUsers.push({
              id: userId,
              name: userName,
              photo: userPhoto ? userPhoto.photo : '<?php echo e(asset("new_theme/dist/img/avatar.png")); ?>'
            });
          }
        });
  ...
  function updateNoteEmployees() {
    ...
    fetch('<?php echo e(url("/api/admin-notes")); ?>/' + editingNoteId + '/employees', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Accept': 'application/json',
  ...
  (function(){
    try{
      ...
      var selectedUsers = [];
      var allUsers = <?php echo json_encode($users ?? [], 15, 512) ?>;
      var modal = document.getElementById('employeeModal');
      ...
      function updateChipsDisplay() {
        ...
        if (selectedUsers.length === 0) {
          ...
          selectedUsers.forEach(function(user, idx) {
            ...
            chip.innerHTML = '<img src="' + user.photo + '" style="width: 24px; height: 24px; border-radius: 50%; object-fit: cover;" onerror="this.src=\'<?php echo e(asset('new_theme/dist/img/avatar.png')); ?>\'">' +
              '<span>' + user.name + '</span>' +
      ...
      document.querySelectorAll('.employee-card input[type="checkbox"]').forEach(function(cb) {
        cb.addEventListener('change', function() {
          ...
          var userPhoto = allUsers.find(function(u) { return u.id == userId; })?.photo || '<?php echo e(asset('new_theme/dist/img/avatar.png')); ?>';
      ...
      if (saveBtn) {
        saveBtn.addEventListener('click', function() {
          ...
          fetch('<?php echo e(route("admin.notes.store")); ?>', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Accept': 'application/json',
      ...
      if (notesSendBtn) {
        notesSendBtn.addEventListener('click', function() {
          ...
          fetch('<?php echo e(route("employee.notes.store")); ?>', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Accept': 'application/json',
...
<?php echo $__env->make('layouts.macos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/dashboard.blade.php ENDPATH**/ ?>