      ...
      <div class="notes-scroll-container">
        <div id="systemNotesContainer" class="notes-grid">
          <?php $__empty_1 = true; $__currentLoopData = $systemNotes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            ?>
            <div class="note-card">
              <div class="note-card-text"><?php echo e($displayText); ?></div>
              <?php if($isTruncated): ?>
                <span class="read-more-link" data-full-text="<?php echo e(urlencode($noteText)); ?>" data-date="<?php echo e($note['date']); ?>" data-assignees="" onclick="openNoteFromData(this)">
                  Read More 
        ...
        <div style="display: flex; gap: 16px; min-width: max-content; padding: 4px;">
          <?php $__empty_1 = true; $__currentLoopData = $empNotes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="note-card-blue">
              <div class="note-card-blue-text"><?php echo e($empDisplayText); ?></div>
              <?php if($empIsTruncated): ?>
                <span class="read-more-link" data-full-text="<?php echo e(urlencode($empNoteText)); ?>" data-date="<?php echo e($note['date'] ?? now()->format('M d, Y')); ?>" data-assignees="<?php echo e(urlencode(json_encode($assigneesList))); ?>" onclick="openNoteFromData(this)">
                  Read More 
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                </span>
              <?php endif; ?>
              <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-bottom: 12px; margin-top: 8px;">
                <?php if(count($assigneesList) > 0): ?>
                  <?php $__currentLoopData = $assigneesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
