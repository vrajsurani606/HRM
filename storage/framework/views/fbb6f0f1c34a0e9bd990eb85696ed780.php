...
<body class="antialiased text-slate-800 bg-soft-1">
  ...
  <section id="quick-access" class="py-16">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <a href="<?php echo e(route('employees.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('payroll.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('inquiries.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('quotations.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('companies.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('projects.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('performas.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('invoices.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
            <div class="w-11 h-11 rounded-lg bg-emerald-50 flex items-center justify-center">
        ...
        <a href="<?php echo e(route('receipts.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('tickets.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('attendance.report')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('leave-approval.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('events.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('settings.index')); ?>" class="p-5 bg-white rounded-2xl shadow hover:shadow-lg transition block">
          <div class="flex items-center gap-3">
            <div class="w-11 h-11 rounded-lg bg-slate-50 flex items-center justify-center">
  ...
  <script>
    ...
    lottie.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      path: "<?php echo e(asset('public/lottie/Project-config.json')); ?>" // local Lottie JSON
    });
...
<?php /**PATH C:\xampp\htdocs\GitVraj\HrPortal\resources\views/welcome.blade.php ENDPATH**/ ?>