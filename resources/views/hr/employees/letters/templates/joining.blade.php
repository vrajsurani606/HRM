    ...
    <div class="letter-container">
        ...
        <div class="letter-content">
            ...
            <div class="body">
                ...
                <p>We are pleased to welcome you to <span class="company">{{ $company_name }}</span>. This letter confirms your joining as <span class="highlight">{{ $letter->employee->designation ?? 'Employee' }}</span> in our organization.</p>
                
                <p><b>Your employment details are as follows:</b></p>
                <ul>
                    ...
                    <li><b>Date of Joining:</b> {{ $letter->employee->date_of_joining ? $letter->employee->date_of_joining->format('d-m-Y') : 'As mentioned in offer letter' }}</li>
                    <li><b>Reporting Manager:</b> {{ $letter->employee->reporting_manager ?? 'As assigned' }}</li>
                </ul>

                <p>Please ensure that you have submitted all required documents as mentioned in your offer letter. You are requested to report to the HR department on your first day for completion of joining formalities.</p>
