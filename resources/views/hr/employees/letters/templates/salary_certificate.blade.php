    ...
    <div class="letter-container">
        ...
        <div class="letter-content">
            ...
            <div class="body">
                ...
                <ul>
                    <li><b>Current Monthly Salary:</b> ₹ {{ $letter->content['monthly_salary'] ?? '___________' }}</li>
                    <li><b>Annual CTC:</b> ₹ {{ $letter->content['annual_ctc'] ?? '___________' }}</li>
                    <li><b>Basic Salary:</b> ₹ {{ $letter->content['basic_salary'] ?? '___________' }}</li>
                    <li><b>Allowances:</b> ₹ {{ $letter->content['allowances'] ?? '___________' }}</li>
                </ul>

                <p>This certificate is issued upon the request of the employee for {{ $letter->content['purpose'] ?? 'official purposes' }}.</p>
