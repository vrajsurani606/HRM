...
<head>
    ...
    <title>Confidentiality Agreement - {{ $letter->employee->name }}</title>
    <style>
    ...
    <div class="letter-container">
        ...
        <div class="letter-content">
            ...
            <div class="body">
                ...
                <p>This Confidentiality Agreement is entered into between <span class="company">{{ $company_name }}</span> and you as an employee of the company.</p>
                ...
                <ol>
                    ...
                    <li><b>Non-Disclosure:</b> You agree not to disclose, reveal, or make use of any confidential information for personal gain or to the detriment of the company.</li>
                    <li><b>Return of Information:</b> Upon termination of employment, you agree to return all confidential materials and information to the company.</li>
                    <li><b>Duration:</b> This agreement shall remain in effect during your employment and for a period of 2 years after termination.</li>
                    <li><b>Legal Consequences:</b> Breach of this agreement may result in legal action and claims for damages.</li>
                </ol>

                <p>By signing below, you acknowledge that you have read, understood, and agree to be bound by the terms of this Confidentiality Agreement.</p>
            </div>
            <div class="signature">
