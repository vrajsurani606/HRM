<aside id="hrpSidebar" class="hrp-sidebar">
  <div class="hrp-sidebar-inner">
    ...
    <ul class="hrp-menu">
      ...
      @php($canViewAttendance = auth()->user()->can('Attendance Management.view attendance') || auth()->user()->can('Attendance Management.view attendance report'))
      @php($canApproveLeave = auth()->user()->can('Leave Approval Management.view leave approval') || auth()->user()->can('Leave Approval Management.approve leave') || auth()->user()->can('Leave Management.approve leave') || auth()->user()->can('Leave Management.manage leave'))
      @if($canViewAttendance || $canApproveLeave)
