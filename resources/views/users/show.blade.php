        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          @can('Users Management.view user')
            ...
            <div>
              ...
              <div class="hrp-input Rectangle-29" style="display:flex;align-items:center;min-height:44px;gap:8px;justify-content:space-between">
                <span id="user-password-{{ $user->id }}" data-password="{{ $user->plain_password }}" style="flex:1;font-family:inherit;font-size:inherit;letter-spacing:1px">••••••••</span>
                <div style="display:flex;gap:4px">
                  <button type="button" onclick="togglePasswordVisibility({{ $user->id }})" style="background:#3b82f6;border:none;padding:6px 10px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:white;border-radius:6px" title="Show/Hide Password">
                  ...
                  <button type="button" onclick="copyToClipboard('{{ $user->plain_password }}')" style="background:#10b981;border:none;padding:6px 10px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:white;border-radius:6px" title="Copy Password">
...
function togglePasswordVisibility(userId) {
    ...
    const password = field.getAttribute('data-password');
    const isHidden = field.getAttribute('data-hidden') !== 'false';
