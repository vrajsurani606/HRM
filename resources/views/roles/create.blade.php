        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3" style="margin-top:12px;">
          <div>
            ...
            <select name="dashboard_type" class="hrp-input Rectangle-29" required>
              <option value="admin" {{ old('dashboard_type') == 'admin' ? 'selected' : '' }}>Admin Dashboard (Full Access)</option>
              <option value="employee" {{ old('dashboard_type') == 'employee' ? 'selected' : '' }}>Employee Dashboard</option>
              <option value="customer" {{ old('dashboard_type') == 'customer' ? 'selected' : '' }}>Customer/Client Dashboard</option>
              <option value="hr" {{ old('dashboard_type') == 'hr' ? 'selected' : '' }}>HR Dashboard</option>
              <option value="receptionist" {{ old('dashboard_type') == 'receptionist' ? 'selected' : '' }}>Receptionist Dashboard</option>
            </select>
            ...
            <div class="data-access-panel" style="padding:12px 15px; background:#fef3c7; border:1px solid #f59e0b; border-radius:8px; height:100%;">
              <div style="display:flex; align-items:center; justify-content:space-between; height:100%;">
                ...
                <label class="custom-checkbox" style="margin:0;">
                  <input type="checkbox" name="restrict_to_own_data" value="1" {{ old('restrict_to_own_data') ? 'checked' : '' }}>
