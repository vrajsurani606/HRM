  ...
  <div class="Rectangle-30 hrp-compact">
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
        ...
        <div>
          ...
          <input type="text" class="Rectangle-29 date-picker @error('invoice_date') is-invalid @enderror" name="invoice_date" placeholder="dd/mm/yyyy" value="{{ old('invoice_date', $invoice->invoice_date ? $invoice->invoice_date->format('d/m/Y') : '') }}" autocomplete="off" required>
