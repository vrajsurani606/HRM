  ...
  <div class="Rectangle-30 hrp-compact">
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
        ...
        <div>
          ...
          <input type="text" class="Rectangle-29 date-picker @error('proforma_date') is-invalid @enderror" name="proforma_date" placeholder="dd/mm/yyyy" value="{{ old('proforma_date', $proforma->proforma_date?->format('d/m/Y')) }}" autocomplete="off" required>
...
<div class="Rectangle-30 hrp-compact">
  ...
  <div id="cgstSgstFieldsRow" style="display: none; grid-template-columns: repeat(4, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
    <div>
      ...
      <input type="number" class="Rectangle-29 js-cgst-per" name="cgst_percent" value="{{ old('cgst_percent', $proforma->cgst_percent) }}" placeholder="9">
    </div>
    <div>
      <label class="hrp-label">CGST Amount:</label>
      <input class="Rectangle-29" name="cgst_amount" id="cgstAmount" value="{{ old('cgst_amount', $proforma->cgst_amount) }}" placeholder="0.00" readonly>
    </div>
    <div>
      <label class="hrp-label">SGST Per(%):</label>
      <input type="number" class="Rectangle-29 js-sgst-per" name="sgst_percent" value="{{ old('sgst_percent', $proforma->sgst_percent) }}" placeholder="9">
    </div>
    <div>
      <label class="hrp-label">SGST Amount:</label>
      <input class="Rectangle-29" name="sgst_amount" id="sgstAmount" value="{{ old('sgst_amount', $proforma->sgst_amount) }}" placeholder="0.00" readonly>
    </div>
  </div>
  ...
  <div id="igstFieldsRow" style="display: none; grid-template-columns: repeat(2, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
    <div>
      ...
      <input type="number" class="Rectangle-29 js-igst-per" name="igst_percent" value="{{ old('igst_percent', $proforma->igst_percent) }}" placeholder="18">
    </div>
    <div>
      <label class="hrp-label">IGST Amount:</label>
      <input class="Rectangle-29" name="igst_amount" id="igstAmount" value="{{ old('igst_amount', $proforma->igst_amount) }}" placeholder="0.00" readonly>
    </div>
  </div>
